...
const (
	DayOfWeek_SUNDAY    DayOfWeek = 0 // 周日
	DayOfWeek_MONDAY    DayOfWeek = 1 // 周一
	DayOfWeek_TUESDAY   DayOfWeek = 2 // 周二
	DayOfWeek_WEDNESDAY DayOfWeek = 3 // 周三
	DayOfWeek_THURSDAY  DayOfWeek = 4 // 周四
	DayOfWeek_FRIDAY    DayOfWeek = 5 // 周五
	DayOfWeek_SATURDAY  DayOfWeek = 6 // 周六
)
...
const (
	KickOffReason_DuplicatedLogin KickOffReason = 0 // 重复登录
	KickOffReason_Offline         KickOffReason = 1 // 离线
	KickOffReason_Logout          KickOffReason = 2 // 登出
)
...
const (
	MeetingEndType_CancelType MeetingEndType = 0 // 取消会议
	MeetingEndType_EndType    MeetingEndType = 1 // 正常结束
)
...
type LiveKit struct {
	...
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // 身份验证访问令牌
	Url           string                 `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty"`     // LiveKit服务连接URL
...
type SystemGeneratedMeetingInfo struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	CreatorUserID   string                 `protobuf:"bytes,1,opt,name=creatorUserID,proto3" json:"creatorUserID,omitempty"`     // 创建者用户ID
	CreatorNickname string                 `protobuf:"bytes,2,opt,name=creatorNickname,proto3" json:"creatorNickname,omitempty"` // 创建者昵称
	Status          string                 `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`                   // 会议状态(如: scheduled预约中, in-progress进行中, completed已完成)
	StartTime       int64                  `protobuf:"varint,4,opt,name=startTime,proto3" json:"startTime,omitempty"`            // 会议实际开始时间戳
	MeetingID       string                 `protobuf:"bytes,5,opt,name=meetingID,proto3" json:"meetingID,omitempty"`             // 会议唯一标识符
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CreatorDefinedMeetingInfo struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Title           string                 `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`                      // 会议标题
	ScheduledTime   int64                  `protobuf:"varint,2,opt,name=scheduledTime,proto3" json:"scheduledTime,omitempty"`     // 会议计划开始时间戳
	MeetingDuration int64                  `protobuf:"varint,3,opt,name=meetingDuration,proto3" json:"meetingDuration,omitempty"` // 会议时长(秒)
	Password        string                 `protobuf:"bytes,4,opt,name=password,proto3" json:"password,omitempty"`                // 加入会议密码(可选)
	TimeZone        string                 `protobuf:"bytes,5,opt,name=timeZone,proto3" json:"timeZone,omitempty"`                // 时区设置
	HostUserID      string                 `protobuf:"bytes,6,opt,name=hostUserID,proto3" json:"hostUserID,omitempty"`            // 主持人用户ID
	CoHostUSerID    []string               `protobuf:"bytes,7,rep,name=coHostUSerID,proto3" json:"coHostUSerID,omitempty"`        // 联席主持人用户ID列表
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type MeetingInfo struct {
	state                 protoimpl.MessageState      `protogen:"open.v1"`
	SystemGenerated       *SystemGeneratedMeetingInfo `protobuf:"bytes,1,opt,name=systemGenerated,proto3" json:"systemGenerated,omitempty"`             // 系统生成信息
	CreatorDefinedMeeting *CreatorDefinedMeetingInfo  `protobuf:"bytes,2,opt,name=creatorDefinedMeeting,proto3" json:"creatorDefinedMeeting,omitempty"` // 用户定义信息
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type MeetingRepeatInfo struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	EndDate          int64                  `protobuf:"varint,1,opt,name=endDate,proto3" json:"endDate,omitempty"`                                                             // 重复结束日期
	RepeatTimes      int32                  `protobuf:"varint,2,opt,name=repeatTimes,proto3" json:"repeatTimes,omitempty"`                                                     // 重复次数
	RepeatType       string                 `protobuf:"bytes,3,opt,name=repeatType,proto3" json:"repeatType,omitempty"`                                                        // 重复类型
	UintType         string                 `protobuf:"bytes,4,opt,name=uintType,proto3" json:"uintType,omitempty"`                                                            // 单位类型
	Interval         int32                  `protobuf:"varint,5,opt,name=interval,proto3" json:"interval,omitempty"`                                                           // 重复间隔
	RepeatDaysOfWeek []DayOfWeek            `protobuf:"varint,6,rep,packed,name=repeatDaysOfWeek,proto3,enum=openmeeting.meeting.DayOfWeek" json:"repeatDaysOfWeek,omitempty"` // 每周重复的星期
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type MeetingSetting struct {
	state                           protoimpl.MessageState `protogen:"open.v1"`
	CanParticipantsEnableCamera     bool                   `protobuf:"varint,1,opt,name=canParticipantsEnableCamera,proto3" json:"canParticipantsEnableCamera,omitempty"`         // 参与者是否可以开启摄像头
	CanParticipantsUnmuteMicrophone bool                   `protobuf:"varint,2,opt,name=canParticipantsUnmuteMicrophone,proto3" json:"canParticipantsUnmuteMicrophone,omitempty"` // 参与者是否可以开启麦克风
	CanParticipantsShareScreen      bool                   `protobuf:"varint,3,opt,name=canParticipantsShareScreen,proto3" json:"canParticipantsShareScreen,omitempty"`           // 参与者是否可以共享屏幕
	DisableCameraOnJoin             bool                   `protobuf:"varint,4,opt,name=disableCameraOnJoin,proto3" json:"disableCameraOnJoin,omitempty"`                         // 加入时是否默认关闭摄像头
	DisableMicrophoneOnJoin         bool                   `protobuf:"varint,5,opt,name=disableMicrophoneOnJoin,proto3" json:"disableMicrophoneOnJoin,omitempty"`                 // 加入时是否默认关闭麦克风
	CanParticipantJoinMeetingEarly  bool                   `protobuf:"varint,6,opt,name=canParticipantJoinMeetingEarly,proto3" json:"canParticipantJoinMeetingEarly,omitempty"`   // 是否允许参与者提前加入会议
	LockMeeting                     bool                   `protobuf:"varint,7,opt,name=lockMeeting,proto3" json:"lockMeeting,omitempty"`                                         // 是否锁定会议(锁定后新用户无法加入)
	AudioEncouragement              bool                   `protobuf:"varint,8,opt,name=audioEncouragement,proto3" json:"audioEncouragement,omitempty"`                           // 是否启用音频激励提示
	VideoMirroring                  bool                   `protobuf:"varint,9,opt,name=videoMirroring,proto3" json:"videoMirroring,omitempty"`                                   // 是否启用视频镜像
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
type MeetingInfoSetting struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Info          *MeetingInfo           `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`             // 会议基本信息
	Setting       *MeetingSetting        `protobuf:"bytes,2,opt,name=setting,proto3" json:"setting,omitempty"`       // 会议设置
	RepeatInfo    *MeetingRepeatInfo     `protobuf:"bytes,3,opt,name=repeatInfo,proto3" json:"repeatInfo,omitempty"` // 重复周期信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserInfo struct {
	...
	FaceURL       string                 `protobuf:"bytes,4,opt,name=faceURL,proto3" json:"faceURL,omitempty"`   // 头像URL
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BookMeetingReq struct {
	state                     protoimpl.MessageState     `protogen:"open.v1"`
	CreatorUserID             string                     `protobuf:"bytes,1,opt,name=creatorUserID,proto3" json:"creatorUserID,omitempty"`                         // 创建者用户ID
	CreatorDefinedMeetingInfo *CreatorDefinedMeetingInfo `protobuf:"bytes,2,opt,name=creatorDefinedMeetingInfo,proto3" json:"creatorDefinedMeetingInfo,omitempty"` // 会议定义信息
	Setting                   *MeetingSetting            `protobuf:"bytes,3,opt,name=setting,proto3" json:"setting,omitempty"`                                     // 会议设置
	RepeatInfo                *MeetingRepeatInfo         `protobuf:"bytes,4,opt,name=repeatInfo,proto3" json:"repeatInfo,omitempty"`                               // 重复周期信息
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
type BookMeetingResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Detail        *MeetingInfoSetting    `protobuf:"bytes,1,opt,name=detail,proto3" json:"detail,omitempty"` // 会议详细信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CreateImmediateMeetingResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Detail        *MeetingInfoSetting    `protobuf:"bytes,1,opt,name=detail,proto3" json:"detail,omitempty"`   // 会议详细信息
	LiveKit       *LiveKit               `protobuf:"bytes,2,opt,name=liveKit,proto3" json:"liveKit,omitempty"` // LiveKit连接信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type JoinMeetingReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MeetingID     string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"` // 会议ID
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`       // 加入会议的用户ID
	Password      string                 `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`   // 会议密码(可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type JoinMeetingResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LiveKit       *LiveKit               `protobuf:"bytes,1,opt,name=liveKit,proto3" json:"liveKit,omitempty"` // LiveKit连接信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LeaveMeetingReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MeetingID     string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"` // 会议ID
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`       // 离开会议的用户ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type EndMeetingReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MeetingID     string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`                                      // 会议ID
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`                                            // 操作者用户ID
	EndType       MeetingEndType         `protobuf:"varint,3,opt,name=endType,proto3,enum=openmeeting.meeting.MeetingEndType" json:"endType,omitempty"` // 结束类型
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetMeetingsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"` // 用户ID
	Status        []string               `protobuf:"bytes,2,rep,name=status,proto3" json:"status,omitempty"` // 状态过滤器(如: scheduled预约中, in-progress进行中, completed已完成)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetMeetingsResp struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	MeetingDetails []*MeetingInfoSetting  `protobuf:"bytes,1,rep,name=meetingDetails,proto3" json:"meetingDetails,omitempty"` // 会议详情列表
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GetMeetingReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`       // 用户ID
	MeetingID     string                 `protobuf:"bytes,2,opt,name=meetingID,proto3" json:"meetingID,omitempty"` // 会议ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetMeetingResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MeetingDetail *MeetingInfoSetting    `protobuf:"bytes,1,opt,name=meetingDetail,proto3" json:"meetingDetail,omitempty"` // 会议详情
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ModifyMeetingParticipantNickNameReq struct {
	...
	MeetingID         string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`                 // 会议ID
	UserID            string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`                       // 操作者用户ID
	ParticipantUserID string                 `protobuf:"bytes,3,opt,name=participantUserID,proto3" json:"participantUserID,omitempty"` // 被修改的参与者用户ID
	Nickname          string                 `protobuf:"bytes,4,opt,name=nickname,proto3" json:"nickname,omitempty"`                   // 新昵称
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type UpdateMeetingRequest struct {
	state                           protoimpl.MessageState  `protogen:"open.v1"`
	MeetingID                       string                  `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`                                              // 会议ID
	UpdatingUserID                  string                  `protobuf:"bytes,2,opt,name=updatingUserID,proto3" json:"updatingUserID,omitempty"`                                    // 更新者用户ID
	Title                           *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=title,proto3" json:"title,omitempty"`                                                      // 会议标题
	ScheduledTime                   *wrapperspb.Int64Value  `protobuf:"bytes,4,opt,name=scheduledTime,proto3" json:"scheduledTime,omitempty"`                                      // 计划开始时间
	MeetingDuration                 *wrapperspb.Int64Value  `protobuf:"bytes,5,opt,name=meetingDuration,proto3" json:"meetingDuration,omitempty"`                                  // 会议时长
	Password                        *wrapperspb.StringValue `protobuf:"bytes,6,opt,name=password,proto3" json:"password,omitempty"`                                                // 会议密码
	TimeZone                        *wrapperspb.StringValue `protobuf:"bytes,7,opt,name=timeZone,proto3" json:"timeZone,omitempty"`                                                // 时区
	RepeatInfo                      *MeetingRepeatInfo      `protobuf:"bytes,8,opt,name=repeatInfo,proto3" json:"repeatInfo,omitempty"`                                            // 重复周期信息
	CanParticipantsEnableCamera     *wrapperspb.BoolValue   `protobuf:"bytes,9,opt,name=canParticipantsEnableCamera,proto3" json:"canParticipantsEnableCamera,omitempty"`          // 是否可开启摄像头
	CanParticipantsUnmuteMicrophone *wrapperspb.BoolValue   `protobuf:"bytes,10,opt,name=canParticipantsUnmuteMicrophone,proto3" json:"canParticipantsUnmuteMicrophone,omitempty"` // 是否可开启麦克风
	CanParticipantsShareScreen      *wrapperspb.BoolValue   `protobuf:"bytes,11,opt,name=canParticipantsShareScreen,proto3" json:"canParticipantsShareScreen,omitempty"`           // 是否可共享屏幕
	DisableCameraOnJoin             *wrapperspb.BoolValue   `protobuf:"bytes,12,opt,name=disableCameraOnJoin,proto3" json:"disableCameraOnJoin,omitempty"`                         // 加入时关闭摄像头
	DisableMicrophoneOnJoin         *wrapperspb.BoolValue   `protobuf:"bytes,13,opt,name=disableMicrophoneOnJoin,proto3" json:"disableMicrophoneOnJoin,omitempty"`                 // 加入时关闭麦克风
	CanParticipantJoinMeetingEarly  *wrapperspb.BoolValue   `protobuf:"bytes,14,opt,name=canParticipantJoinMeetingEarly,proto3" json:"canParticipantJoinMeetingEarly,omitempty"`   // 可提前加入
	LockMeeting                     *wrapperspb.BoolValue   `protobuf:"bytes,15,opt,name=lockMeeting,proto3" json:"lockMeeting,omitempty"`                                         // 是否锁定会议
	AudioEncouragement              *wrapperspb.BoolValue   `protobuf:"bytes,16,opt,name=audioEncouragement,proto3" json:"audioEncouragement,omitempty"`                           // 音频激励
	VideoMirroring                  *wrapperspb.BoolValue   `protobuf:"bytes,17,opt,name=videoMirroring,proto3" json:"videoMirroring,omitempty"`                                   // 视频镜像
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
type PersonalMeetingSetting struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	CameraOnEntry     bool                   `protobuf:"varint,1,opt,name=cameraOnEntry,proto3" json:"cameraOnEntry,omitempty"`         // 加入会议时是否默认开启摄像头
	MicrophoneOnEntry bool                   `protobuf:"varint,2,opt,name=microphoneOnEntry,proto3" json:"microphoneOnEntry,omitempty"` // 加入会议时是否默认开启麦克风
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type GetPersonalMeetingSettingsResp struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Setting       *PersonalMeetingSetting `protobuf:"bytes,1,opt,name=setting,proto3" json:"setting,omitempty"` // 个人设置
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetPersonalMeetingSettingsReq struct {
	...
	MeetingID         string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`                 // 会议ID
	UserID            string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`                       // 用户ID
	CameraOnEntry     *wrapperspb.BoolValue  `protobuf:"bytes,3,opt,name=cameraOnEntry,proto3" json:"cameraOnEntry,omitempty"`         // 加入时是否开启摄像头
	MicrophoneOnEntry *wrapperspb.BoolValue  `protobuf:"bytes,4,opt,name=microphoneOnEntry,proto3" json:"microphoneOnEntry,omitempty"` // 加入时是否开启麦克风
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type PersonalData struct {
	state           protoimpl.MessageState  `protogen:"open.v1"`
	UserID          string                  `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                   // 用户ID
	PersonalSetting *PersonalMeetingSetting `protobuf:"bytes,2,opt,name=personalSetting,proto3" json:"personalSetting,omitempty"` // 个人设置
	LimitSetting    *PersonalMeetingSetting `protobuf:"bytes,3,opt,name=limitSetting,proto3" json:"limitSetting,omitempty"`       // 限制设置(主持人对该用户的流操作限制)
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type MeetingMetadata struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Detail        *MeetingInfoSetting    `protobuf:"bytes,1,opt,name=detail,proto3" json:"detail,omitempty"`             // 会议详情
	PersonalData  []*PersonalData        `protobuf:"bytes,2,rep,name=personalData,proto3" json:"personalData,omitempty"` // 个人数据列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type OperateRoomAllStreamReq struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	MeetingID         string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`                 // 会议ID
	OperatorUserID    string                 `protobuf:"bytes,2,opt,name=operatorUserID,proto3" json:"operatorUserID,omitempty"`       // 操作者用户ID
	CameraOnEntry     *wrapperspb.BoolValue  `protobuf:"bytes,3,opt,name=cameraOnEntry,proto3" json:"cameraOnEntry,omitempty"`         // 统一设置摄像头
	MicrophoneOnEntry *wrapperspb.BoolValue  `protobuf:"bytes,4,opt,name=microphoneOnEntry,proto3" json:"microphoneOnEntry,omitempty"` // 统一设置麦克风
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type OperateRoomAllStreamResp struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	StreamNotExistUserIDList []string               `protobuf:"bytes,1,rep,name=streamNotExistUserIDList,proto3" json:"streamNotExistUserIDList,omitempty"` // 流不存在的用户ID列表
	FailedUserIDList         []string               `protobuf:"bytes,2,rep,name=failedUserIDList,proto3" json:"failedUserIDList,omitempty"`                 // 操作失败的用户ID列表
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type RemoveMeetingParticipantsReq struct {
	...
	MeetingID          string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`                   // 会议ID
	UserID             string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`                         // 操作者用户ID
	ParticipantUserIDs []string               `protobuf:"bytes,3,rep,name=participantUserIDs,proto3" json:"participantUserIDs,omitempty"` // 被移除的参与者ID列表
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type RemoveMeetingParticipantsResp struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	SuccessUserIDList []string               `protobuf:"bytes,1,rep,name=successUserIDList,proto3" json:"successUserIDList,omitempty"` // 成功移除的用户ID列表
	FailedUserIDList  []string               `protobuf:"bytes,2,rep,name=failedUserIDList,proto3" json:"failedUserIDList,omitempty"`   // 移除失败的用户ID列表
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type SetMeetingHostInfoReq struct {
	...
	MeetingID     string                  `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`         // 会议ID
	UserID        string                  `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`               // 操作者用户ID
	HostUserID    *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=hostUserID,proto3" json:"hostUserID,omitempty"`       // 新主持人用户ID
	CoHostUserIDs []string                `protobuf:"bytes,4,rep,name=coHostUserIDs,proto3" json:"coHostUserIDs,omitempty"` // 联席主持人用户ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type NotifyMeetingData struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	OperatorUserID string                 `protobuf:"bytes,1,opt,name=operatorUserID,proto3" json:"operatorUserID,omitempty"` // 操作者用户ID
...
type NotifyMeetingData_StreamOperateData struct {
	StreamOperateData *StreamOperateData `protobuf:"bytes,2,opt,name=streamOperateData,proto3,oneof"` // 流操作数据
}

type NotifyMeetingData_MeetingHostData struct {
	MeetingHostData *MeetingHostData `protobuf:"bytes,3,opt,name=meetingHostData,proto3,oneof"` // 主持人变更数据
}

type NotifyMeetingData_KickOffMeetingData struct {
	KickOffMeetingData *KickOffMeetingData `protobuf:"bytes,4,opt,name=kickOffMeetingData,proto3,oneof"` // 踢出会议数据
}
...
type KickOffMeetingData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                                                 // 被踢出用户ID
	Nickname      string                 `protobuf:"bytes,2,opt,name=nickname,proto3" json:"nickname,omitempty"`                                             // 被踢出用户昵称
	ReasonCode    KickOffReason          `protobuf:"varint,3,opt,name=reasonCode,proto3,enum=openmeeting.meeting.KickOffReason" json:"reasonCode,omitempty"` // 踢出原因
	Reason        string                 `protobuf:"bytes,4,opt,name=reason,proto3" json:"reason,omitempty"`                                                 // 踢出原因描述
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type StreamOperateData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Operation     []*UserOperationData   `protobuf:"bytes,1,rep,name=operation,proto3" json:"operation,omitempty"` // 用户操作数据列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserOperationData struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	UserID            string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                       // 用户ID
	CameraOnEntry     *wrapperspb.BoolValue  `protobuf:"bytes,2,opt,name=cameraOnEntry,proto3" json:"cameraOnEntry,omitempty"`         // 摄像头设置
	MicrophoneOnEntry *wrapperspb.BoolValue  `protobuf:"bytes,3,opt,name=microphoneOnEntry,proto3" json:"microphoneOnEntry,omitempty"` // 麦克风设置
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type MeetingHostData struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	OperatorNickname string                 `protobuf:"bytes,2,opt,name=operatorNickname,proto3" json:"operatorNickname,omitempty"` // 操作者昵称
	UserID           string                 `protobuf:"bytes,3,opt,name=userID,proto3" json:"userID,omitempty"`                     // 用户ID
	HostType         string                 `protobuf:"bytes,4,opt,name=hostType,proto3" json:"hostType,omitempty"`                 // 主持人类型
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type CleanPreviousMeetingsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`          // 用户ID
	ReasonCode    int32                  `protobuf:"varint,2,opt,name=reasonCode,proto3" json:"reasonCode,omitempty"` // 原因代码
	Reason        string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`          // 原因描述
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ToggleRecordMeetingReq struct {
	...
	MeetingID     string                 `protobuf:"bytes,1,opt,name=meetingID,proto3" json:"meetingID,omitempty"`        // 会议ID
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`              // 用户ID
	EnableRecord  bool                   `protobuf:"varint,3,opt,name=enableRecord,proto3" json:"enableRecord,omitempty"` // 是否启用录制
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_openmeeting_meeting_meeting_proto_rawDesc = "" +
	...
	"$ModifyMeetingParticipantNickNameResp\"\xe8\t\n" +
	"\x14UpdateMeetingRequest\x12\x1c\n" +
	"\tmeetingID\x18\x01 \x01(\tR\tmeetingID\x12&\n" +
	"\x0eupdatingUserID\x18\x02 \x01(\tR\x0eupdatingUserID\x124\n" +
	"\x05title\x18\x03 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x05title\x12C\n" +
	"\rscheduledTime\x18\x04 \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\rscheduledTime\x12G\n" +
	"\x0fmeetingDuration\x18\x05 \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x0fmeetingDuration\x12:\n" +
	"\bpassword\x18\x06 \x01(\v2\x1e.openim.wrapperspb.StringValueR\bpassword\x12:\n" +
	"\btimeZone\x18\a \x01(\v2\x1e.openim.wrapperspb.StringValueR\btimeZone\x12F\n" +
	"\n" +
	"repeatInfo\x18\b \x01(\v2&.openmeeting.meeting.MeetingRepeatInfoR\n" +
	"repeatInfo\x12^\n" +
	"\x1bcanParticipantsEnableCamera\x18\t \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x1bcanParticipantsEnableCamera\x12f\n" +
	"\x1fcanParticipantsUnmuteMicrophone\x18\n" +
	" \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x1fcanParticipantsUnmuteMicrophone\x12\\\n" +
	"\x1acanParticipantsShareScreen\x18\v \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x1acanParticipantsShareScreen\x12N\n" +
	"\x13disableCameraOnJoin\x18\f \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x13disableCameraOnJoin\x12V\n" +
	"\x17disableMicrophoneOnJoin\x18\r \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x17disableMicrophoneOnJoin\x12d\n" +
	"\x1ecanParticipantJoinMeetingEarly\x18\x0e \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x1ecanParticipantJoinMeetingEarly\x12>\n" +
	"\vlockMeeting\x18\x0f \x01(\v2\x1c.openim.wrapperspb.BoolValueR\vlockMeeting\x12L\n" +
	"\x12audioEncouragement\x18\x10 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x12audioEncouragement\x12D\n" +
	"\x0evideoMirroring\x18\x11 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x0evideoMirroring\"\x13\n" +
	...
	"\asetting\x18\x01 \x01(\v2+.openmeeting.meeting.PersonalMeetingSettingR\asetting\"\xe5\x01\n" +
	"\x1dSetPersonalMeetingSettingsReq\x12\x1c\n" +
	"\tmeetingID\x18\x01 \x01(\tR\tmeetingID\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\tR\x06userID\x12B\n" +
	"\rcameraOnEntry\x18\x03 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\rcameraOnEntry\x12J\n" +
	"\x11microphoneOnEntry\x18\x04 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x11microphoneOnEntry\" \n" +
	...
	"\fpersonalData\x18\x02 \x03(\v2!.openmeeting.meeting.PersonalDataR\fpersonalData\"\xef\x01\n" +
	"\x17OperateRoomAllStreamReq\x12\x1c\n" +
	"\tmeetingID\x18\x01 \x01(\tR\tmeetingID\x12&\n" +
	"\x0eoperatorUserID\x18\x02 \x01(\tR\x0eoperatorUserID\x12B\n" +
	"\rcameraOnEntry\x18\x03 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\rcameraOnEntry\x12J\n" +
	"\x11microphoneOnEntry\x18\x04 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x11microphoneOnEntry\"\x82\x01\n" +
	...
	"\x10failedUserIDList\x18\x02 \x03(\tR\x10failedUserIDList\"\xb3\x01\n" +
	"\x15SetMeetingHostInfoReq\x12\x1c\n" +
	"\tmeetingID\x18\x01 \x01(\tR\tmeetingID\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\tR\x06userID\x12>\n" +
	"\n" +
	"hostUserID\x18\x03 \x01(\v2\x1e.openim.wrapperspb.StringValueR\n" +
	"hostUserID\x12$\n" +
	...
	"\toperation\x18\x01 \x03(\v2&.openmeeting.meeting.UserOperationDataR\toperation\"\xbb\x01\n" +
	"\x11UserOperationData\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12B\n" +
	"\rcameraOnEntry\x18\x02 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\rcameraOnEntry\x12J\n" +
	"\x11microphoneOnEntry\x18\x03 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\x11microphoneOnEntry\"q\n" +
	...
	"\x13ToggleRecordMeeting\x12+.openmeeting.meeting.ToggleRecordMeetingReq\x1a,.openmeeting.meeting.ToggleRecordMeetingRespB=Z;github.com/PaperMan11/goim/pkg/protocol/openmeeting/meetingb\x06proto3"
...
var file_openmeeting_meeting_meeting_proto_goTypes = []any{
	...
	(*wrapperspb.StringValue)(nil),               // 54: openim.wrapperspb.StringValue
	(*wrapperspb.Int64Value)(nil),                // 55: openim.wrapperspb.Int64Value
	(*wrapperspb.BoolValue)(nil),                 // 56: openim.wrapperspb.BoolValue
}
var file_openmeeting_meeting_meeting_proto_depIdxs = []int32{
	...
	54, // 20: openmeeting.meeting.UpdateMeetingRequest.title:type_name -> openim.wrapperspb.StringValue
	55, // 21: openmeeting.meeting.UpdateMeetingRequest.scheduledTime:type_name -> openim.wrapperspb.Int64Value
	55, // 22: openmeeting.meeting.UpdateMeetingRequest.meetingDuration:type_name -> openim.wrapperspb.Int64Value
	54, // 23: openmeeting.meeting.UpdateMeetingRequest.password:type_name -> openim.wrapperspb.StringValue
	54, // 24: openmeeting.meeting.UpdateMeetingRequest.timeZone:type_name -> openim.wrapperspb.StringValue
	7,  // 25: openmeeting.meeting.UpdateMeetingRequest.repeatInfo:type_name -> openmeeting.meeting.MeetingRepeatInfo
	56, // 26: openmeeting.meeting.UpdateMeetingRequest.canParticipantsEnableCamera:type_name -> openim.wrapperspb.BoolValue
	56, // 27: openmeeting.meeting.UpdateMeetingRequest.canParticipantsUnmuteMicrophone:type_name -> openim.wrapperspb.BoolValue
	56, // 28: openmeeting.meeting.UpdateMeetingRequest.canParticipantsShareScreen:type_name -> openim.wrapperspb.BoolValue
	56, // 29: openmeeting.meeting.UpdateMeetingRequest.disableCameraOnJoin:type_name -> openim.wrapperspb.BoolValue
	56, // 30: openmeeting.meeting.UpdateMeetingRequest.disableMicrophoneOnJoin:type_name -> openim.wrapperspb.BoolValue
	56, // 31: openmeeting.meeting.UpdateMeetingRequest.canParticipantJoinMeetingEarly:type_name -> openim.wrapperspb.BoolValue
	56, // 32: openmeeting.meeting.UpdateMeetingRequest.lockMeeting:type_name -> openim.wrapperspb.BoolValue
	56, // 33: openmeeting.meeting.UpdateMeetingRequest.audioEncouragement:type_name -> openim.wrapperspb.BoolValue
	56, // 34: openmeeting.meeting.UpdateMeetingRequest.videoMirroring:type_name -> openim.wrapperspb.BoolValue
	32, // 35: openmeeting.meeting.GetPersonalMeetingSettingsResp.setting:type_name -> openmeeting.meeting.PersonalMeetingSetting
	56, // 36: openmeeting.meeting.SetPersonalMeetingSettingsReq.cameraOnEntry:type_name -> openim.wrapperspb.BoolValue
	56, // 37: openmeeting.meeting.SetPersonalMeetingSettingsReq.microphoneOnEntry:type_name -> openim.wrapperspb.BoolValue
	...
	56, // 42: openmeeting.meeting.OperateRoomAllStreamReq.cameraOnEntry:type_name -> openim.wrapperspb.BoolValue
	56, // 43: openmeeting.meeting.OperateRoomAllStreamReq.microphoneOnEntry:type_name -> openim.wrapperspb.BoolValue
	54, // 44: openmeeting.meeting.SetMeetingHostInfoReq.hostUserID:type_name -> openim.wrapperspb.StringValue
	...
	56, // 50: openmeeting.meeting.UserOperationData.cameraOnEntry:type_name -> openim.wrapperspb.BoolValue
	56, // 51: openmeeting.meeting.UserOperationData.microphoneOnEntry:type_name -> openim.wrapperspb.BoolValue
