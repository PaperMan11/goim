...
type AccountCheckReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CheckUserIDs  []string               `protobuf:"bytes,1,rep,name=checkUserIDs,proto3" json:"checkUserIDs,omitempty"` // 需要检查的用户ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AccountCheckResp struct {
	state         protoimpl.MessageState              `protogen:"open.v1"`
	Results       []*AccountCheckRespSingleUserStatus `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"` // 检查结果列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetDesignateUsersResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UsersInfo     []*sdkws.UserInfo      `protobuf:"bytes,1,rep,name=usersInfo,proto3" json:"usersInfo,omitempty"` // 用户信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdateUserInfoReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserInfo      *sdkws.UserInfo        `protobuf:"bytes,1,opt,name=userInfo,proto3" json:"userInfo,omitempty"` // 用户信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdateUserInfoExReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserInfo      *sdkws.UserInfoWithEx  `protobuf:"bytes,1,opt,name=userInfo,proto3" json:"userInfo,omitempty"` // 用户信息(带可选字段)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetGlobalRecvMessageOptReq struct {
	...
	GlobalRecvMsgOpt int32                  `protobuf:"varint,3,opt,name=globalRecvMsgOpt,proto3" json:"globalRecvMsgOpt,omitempty"` // 全局消息接收选项(0-接收, 1-不接收, 2-接收但不通知)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type SetConversationReq struct {
	state            protoimpl.MessageState     `protogen:"open.v1"`
	Conversation     *conversation.Conversation `protobuf:"bytes,1,opt,name=conversation,proto3" json:"conversation,omitempty"`          // 会话信息
	NotificationType int32                      `protobuf:"varint,2,opt,name=notificationType,proto3" json:"notificationType,omitempty"` // 通知类型
	OperationID      string                     `protobuf:"bytes,3,opt,name=operationID,proto3" json:"operationID,omitempty"`            // 操作ID
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type SetRecvMsgOptReq struct {
	...
	RecvMsgOpt       int32                  `protobuf:"varint,3,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`             // 消息接收选项
	NotificationType int32                  `protobuf:"varint,4,opt,name=notificationType,proto3" json:"notificationType,omitempty"` // 通知类型
	OperationID      string                 `protobuf:"bytes,5,opt,name=operationID,proto3" json:"operationID,omitempty"`            // 操作ID
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type GetConversationResp struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Conversation  *conversation.Conversation `protobuf:"bytes,2,opt,name=conversation,proto3" json:"conversation,omitempty"` // 会话信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetConversationsResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Conversations []*conversation.Conversation `protobuf:"bytes,2,rep,name=conversations,proto3" json:"conversations,omitempty"` // 会话列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetAllConversationsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID   string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"` // 所有者ID
	OperationID   string                 `protobuf:"bytes,2,opt,name=operationID,proto3" json:"operationID,omitempty"` // 操作ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BatchSetConversationsReq struct {
	...
	OwnerUserID      string                       `protobuf:"bytes,2,opt,name=OwnerUserID,proto3" json:"OwnerUserID,omitempty"`            // 所有者ID
	NotificationType int32                        `protobuf:"varint,3,opt,name=notificationType,proto3" json:"notificationType,omitempty"` // 通知类型
	OperationID      string                       `protobuf:"bytes,4,opt,name=OperationID,proto3" json:"OperationID,omitempty"`            // 操作ID
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type BatchSetConversationsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       []string               `protobuf:"bytes,2,rep,name=Success,proto3" json:"Success,omitempty"` // 成功的会话ID列表
	Failed        []string               `protobuf:"bytes,3,rep,name=Failed,proto3" json:"Failed,omitempty"`   // 失败的会话ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPaginationUsersReq struct {
	...
	UserID        string                   `protobuf:"bytes,3,opt,name=userID,proto3" json:"userID,omitempty"`         // 用户ID(可选，用于精确查找)
	NickName      string                   `protobuf:"bytes,4,opt,name=nickName,proto3" json:"nickName,omitempty"`     // 昵称(可选，用于模糊搜索)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPaginationUsersResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         int32                  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` // 总数
	Users         []*sdkws.UserInfo      `protobuf:"bytes,2,rep,name=users,proto3" json:"users,omitempty"`  // 用户信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserRegisterReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Users         []*sdkws.UserInfo      `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"` // 用户信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGlobalRecvMessageOptResp struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	GlobalRecvMsgOpt int32                  `protobuf:"varint,1,opt,name=globalRecvMsgOpt,proto3" json:"globalRecvMsgOpt,omitempty"` // 全局消息接收选项
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type UserRegisterCountResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         int64                  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`                                                                           // 总用户数
	Before        int64                  `protobuf:"varint,2,opt,name=before,proto3" json:"before,omitempty"`                                                                         // 开始时间前的用户数
	Count         map[string]int64       `protobuf:"bytes,3,rep,name=count,proto3" json:"count,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 时间段内每日注册数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubscribeOrCancelUsersStatusReq struct {
	...
	UserIDs       []string               `protobuf:"bytes,2,rep,name=userIDs,proto3" json:"userIDs,omitempty"` // 目标用户ID列表
	Genre         int32                  `protobuf:"varint,3,opt,name=genre,proto3" json:"genre,omitempty"`    // 操作类型(1-订阅, 2-取消订阅)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubscribeOrCancelUsersStatusResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StatusList    []*OnlineStatus        `protobuf:"bytes,1,rep,name=statusList,proto3" json:"statusList,omitempty"` // 用户在线状态列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetUserStatusReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`              // 用户ID
	Status        int32                  `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`             // 在线状态
...
type SetUserOnlineStatusReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        []*UserOnlineStatus    `protobuf:"bytes,1,rep,name=status,proto3" json:"status,omitempty"` // 用户在线状态列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProcessUserCommandAddReq struct {
	...
	Uuid          string                  `protobuf:"bytes,3,opt,name=uuid,proto3" json:"uuid,omitempty"`     // 命令唯一标识
	Value         *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=value,proto3" json:"value,omitempty"`   // 命令值(可选)
	Ex            *wrapperspb.StringValue `protobuf:"bytes,5,opt,name=ex,proto3" json:"ex,omitempty"`         // 扩展字段(可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CommandInfoResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          int32                  `protobuf:"varint,1,opt,name=type,proto3" json:"type,omitempty"`             // 命令类型
	CreateTime    int64                  `protobuf:"varint,2,opt,name=createTime,proto3" json:"createTime,omitempty"` // 创建时间戳
	Uuid          string                 `protobuf:"bytes,3,opt,name=uuid,proto3" json:"uuid,omitempty"`              // 命令唯一标识
	Value         string                 `protobuf:"bytes,4,opt,name=value,proto3" json:"value,omitempty"`            // 命令值
...
type ProcessUserCommandGetResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CommandResp   []*CommandInfoResp     `protobuf:"bytes,1,rep,name=CommandResp,proto3" json:"CommandResp,omitempty"` // 命令列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProcessUserCommandGetAllResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CommandResp   []*AllCommandInfoResp  `protobuf:"bytes,1,rep,name=CommandResp,proto3" json:"CommandResp,omitempty"` // 命令列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AddNotificationAccountReq struct {
	...
	AppMangerLevel int32                  `protobuf:"varint,4,opt,name=appMangerLevel,proto3" json:"appMangerLevel,omitempty"` // 应用管理员级别
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type AddNotificationAccountResp struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	UserID         string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                  // 用户ID
	FaceURL        string                 `protobuf:"bytes,2,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                // 头像URL
...
type SearchNotificationAccountReq struct {
	...
	AppManagerLevel *int32                   `protobuf:"varint,2,opt,name=appManagerLevel,proto3,oneof" json:"appManagerLevel,omitempty"` // 应用管理员级别(可选)
...
type SearchNotificationAccountResp struct {
	...
	NotificationAccounts []*NotificationAccountInfo `protobuf:"bytes,2,rep,name=notificationAccounts,proto3" json:"notificationAccounts,omitempty"` // 通知账户列表
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type GetNotificationAccountResp struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Account       *NotificationAccountInfo `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"` // 通知账户信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SortQueryReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Asc           bool                   `protobuf:"varint,1,opt,name=asc,proto3" json:"asc,omitempty"`                                                                                        // 是否升序
	UserIDName    map[string]string      `protobuf:"bytes,2,rep,name=userIDName,proto3" json:"userIDName,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 用户ID和名称映射
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetAllOnlineUsersReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cursor        uint64                 `protobuf:"varint,1,opt,name=cursor,proto3" json:"cursor,omitempty"` // 游标位置
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetAllOnlineUsersResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StatusList    []*OnlineStatus        `protobuf:"bytes,1,rep,name=StatusList,proto3" json:"StatusList,omitempty"`  // 在线状态列表
	NextCursor    uint64                 `protobuf:"varint,2,opt,name=nextCursor,proto3" json:"nextCursor,omitempty"` // 下一页游标
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetUserClientConfigResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Configs       map[string]string      `protobuf:"bytes,2,rep,name=configs,proto3" json:"configs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 配置键值对
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DelUserClientConfigReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"` // 用户ID
	Keys          []string               `protobuf:"bytes,2,rep,name=keys,proto3" json:"keys,omitempty"`     // 要删除的配置键列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PageUserClientConfigReq struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	UserID        string                   `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`         // 用户ID
	Key           string                   `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`               // 配置键(可选，用于模糊匹配)
	Pagination    *sdkws.RequestPagination `protobuf:"bytes,3,opt,name=pagination,proto3" json:"pagination,omitempty"` // 分页参数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PageUserClientConfigResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         int64                  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`    // 总数
	Configs       []*ClientConfig        `protobuf:"bytes,2,rep,name=configs,proto3" json:"configs,omitempty"` // 配置列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsIMAdminReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsIMAdminReq) ProtoMessage() {}

func (x *IsIMAdminReq) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[78]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsIMAdminReq.ProtoReflect.Descriptor instead.
func (*IsIMAdminReq) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{78}
}

func (x *IsIMAdminReq) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
// 是否为IM管理员响应
type IsIMAdminResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsIMAdmin     bool                   `protobuf:"varint,1,opt,name=isIMAdmin,proto3" json:"isIMAdmin,omitempty"` // 是否为IM管理员
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *IsIMAdminResp) Reset() {
	*x = IsIMAdminResp{}
...
func (x *IsIMAdminResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsIMAdminResp) ProtoMessage() {}

func (x *IsIMAdminResp) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[79]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsIMAdminResp.ProtoReflect.Descriptor instead.
func (*IsIMAdminResp) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{79}
}

func (x *IsIMAdminResp) GetIsIMAdmin() bool {
	if x != nil {
		return x.IsIMAdmin
	}
	return false
...
type AccountCheckRespSingleUserStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                // 用户ID
	AccountStatus int32                  `protobuf:"varint,2,opt,name=accountStatus,proto3" json:"accountStatus,omitempty"` // 账号状态(0-正常, 1-禁用)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x05value\x18\x04 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x05value\x12.\n" +
	"\x02ex\x18\x05 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\"\x1b\n" +
	"\x19processUserCommandAddResp\"]\n" +
	"\x1bprocessUserCommandDeleteReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x12\n" +
	"\x04type\x18\x02 \x01(\x05R\x04type\x12\x12\n" +
	"\x04uuid\x18\x03 \x01(\tR\x04uuid\"\x1e\n" +
	"\x1cprocessUserCommandDeleteResp\"\xc3\x01\n" +
	"\x1bprocessUserCommandUpdateReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x12\n" +
	"\x04type\x18\x02 \x01(\x05R\x04type\x12\x12\n" +
	"\x04uuid\x18\x03 \x01(\tR\x04uuid\x124\n" +
	"\x05value\x18\x04 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x05value\x12.\n" +
	"\x02ex\x18\x05 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\"\x1e\n" +
	...
	"\fisIMAdminReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\"-\n" +
	"\risIMAdminResp\x12\x1c\n" +
	"\tisIMAdmin\x18\x01 \x01(\bR\tisIMAdmin2\xd5\x17\n" +
	"\x04user\x12Z\n" +
	...
	"\x14pageUserClientConfig\x12$.openim.user.pageUserClientConfigReq\x1a%.openim.user.pageUserClientConfigResp\x12B\n" +
	"\tisIMAdmin\x12\x19.openim.user.isIMAdminReq\x1a\x1a.openim.user.isIMAdminRespB.Z,github.com/PaperMan11/goim/pkg/protocol/userb\x06proto3"
...
var file_user_user_proto_goTypes = []any{
	...
	(*IsIMAdminReq)(nil),                      // 78: openim.user.isIMAdminReq
	(*IsIMAdminResp)(nil),                     // 79: openim.user.isIMAdminResp
	...
	(*wrapperspb.StringValue)(nil),            // 89: openim.wrapperspb.StringValue
}
var file_user_user_proto_depIdxs = []int32{
	...
	89, // 18: openim.user.processUserCommandAddReq.value:type_name -> openim.wrapperspb.StringValue
	89, // 19: openim.user.processUserCommandAddReq.ex:type_name -> openim.wrapperspb.StringValue
	89, // 20: openim.user.processUserCommandUpdateReq.value:type_name -> openim.wrapperspb.StringValue
	89, // 21: openim.user.processUserCommandUpdateReq.ex:type_name -> openim.wrapperspb.StringValue
	...
	78, // 64: openim.user.user.isIMAdmin:input_type -> openim.user.isIMAdminReq
	...
	79, // 95: openim.user.user.isIMAdmin:output_type -> openim.user.isIMAdminResp
