...
type CreateGroupReq struct {
	...
	MemberUserIDs []string               `protobuf:"bytes,1,rep,name=memberUserIDs,proto3" json:"memberUserIDs,omitempty"`    // 群成员ID列表
	GroupInfo     *sdkws.GroupInfo       `protobuf:"bytes,2,opt,name=groupInfo,proto3" json:"groupInfo,omitempty"`            // 群组信息
	AdminUserIDs  []string               `protobuf:"bytes,3,rep,name=adminUserIDs,proto3" json:"adminUserIDs,omitempty"`      // 管理员ID列表
	OwnerUserID   string                 `protobuf:"bytes,4,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`        // 群主ID
	SendMessage   *bool                  `protobuf:"varint,5,opt,name=sendMessage,proto3,oneof" json:"sendMessage,omitempty"` // 是否发送通知消息
...
type CreateGroupResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupInfo     *sdkws.GroupInfo       `protobuf:"bytes,1,opt,name=groupInfo,proto3" json:"groupInfo,omitempty"` // 创建的群组信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupsInfoResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupInfos    []*sdkws.GroupInfo     `protobuf:"bytes,1,rep,name=groupInfos,proto3" json:"groupInfos,omitempty"` // 群组信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetGroupInfoReq struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	GroupInfoForSet *sdkws.GroupInfoForSet `protobuf:"bytes,1,opt,name=groupInfoForSet,proto3" json:"groupInfoForSet,omitempty"` // 群组设置信息
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type SetGroupInfoExReq struct {
	...
	GroupName         *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=groupName,proto3" json:"groupName,omitempty"`                 // 群名称(可选)
	Notification      *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=notification,proto3" json:"notification,omitempty"`           // 群公告(可选)
	Introduction      *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=introduction,proto3" json:"introduction,omitempty"`           // 群介绍(可选)
	FaceURL           *wrapperspb.StringValue `protobuf:"bytes,5,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                     // 群头像(可选)
	...
	LookMemberInfo    *wrapperspb.Int32Value  `protobuf:"bytes,8,opt,name=lookMemberInfo,proto3" json:"lookMemberInfo,omitempty"`       // 是否可见成员信息(可选)
	ApplyMemberFriend *wrapperspb.Int32Value  `protobuf:"bytes,9,opt,name=applyMemberFriend,proto3" json:"applyMemberFriend,omitempty"` // 是否允许申请加好友(可选)
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type GetGroupApplicationListReq struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Pagination    *sdkws.RequestPagination `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"`               // 分页参数
	FromUserID    string                   `protobuf:"bytes,2,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"`               // 管理员/群主ID
	GroupIDs      []string                 `protobuf:"bytes,3,rep,name=groupIDs,proto3" json:"groupIDs,omitempty"`                   // 群组ID列表(可选)
	HandleResults []int32                  `protobuf:"varint,4,rep,packed,name=handleResults,proto3" json:"handleResults,omitempty"` // 处理结果过滤(可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupApplicationListResp struct {
	...
	GroupRequests []*sdkws.GroupRequest  `protobuf:"bytes,2,rep,name=groupRequests,proto3" json:"groupRequests,omitempty"` // 群申请列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupApplicationUnhandledCountReq struct {
	...
	Time          int64                  `protobuf:"varint,2,opt,name=time,proto3" json:"time,omitempty"`    // 时间戳(可选，查询该时间之后的)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupApplicationUnhandledCountResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Count         int64                  `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"` // 未处理数量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TransferGroupOwnerReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	GroupID        string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`               // 群组ID
	OldOwnerUserID string                 `protobuf:"bytes,2,opt,name=oldOwnerUserID,proto3" json:"oldOwnerUserID,omitempty"` // 旧群主ID
	NewOwnerUserID string                 `protobuf:"bytes,3,opt,name=newOwnerUserID,proto3" json:"newOwnerUserID,omitempty"` // 新群主ID
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type JoinGroupReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`             // 群组ID
	ReqMessage    string                 `protobuf:"bytes,2,opt,name=reqMessage,proto3" json:"reqMessage,omitempty"`       // 申请消息
	JoinSource    int32                  `protobuf:"varint,3,opt,name=joinSource,proto3" json:"joinSource,omitempty"`      // 加入来源
	InviterUserID string                 `protobuf:"bytes,4,opt,name=inviterUserID,proto3" json:"inviterUserID,omitempty"` // 邀请者ID(可选)
	Ex            string                 `protobuf:"bytes,5,opt,name=ex,proto3" json:"ex,omitempty"`                       // 扩展字段
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GroupApplicationResponseReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`            // 群组ID
	FromUserID    string                 `protobuf:"bytes,2,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"`      // 申请者ID
	HandledMsg    string                 `protobuf:"bytes,3,opt,name=handledMsg,proto3" json:"handledMsg,omitempty"`      // 处理消息
	HandleResult  int32                  `protobuf:"varint,4,opt,name=handleResult,proto3" json:"handleResult,omitempty"` // 处理结果(1-同意, 2-拒绝)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMemberListReq struct {
	...
	Filter        int32                    `protobuf:"varint,3,opt,name=filter,proto3" json:"filter,omitempty"`        // 过滤条件(0-全部, 1-群主, 2-管理员)
...
type GetGroupMemberListResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Total         uint32                       `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`    // 总数
	Members       []*sdkws.GroupMemberFullInfo `protobuf:"bytes,2,rep,name=members,proto3" json:"members,omitempty"` // 群成员列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMembersInfoResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Members       []*sdkws.GroupMemberFullInfo `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"` // 群成员信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type KickGroupMemberReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`                // 群组ID
	KickedUserIDs []string               `protobuf:"bytes,2,rep,name=kickedUserIDs,proto3" json:"kickedUserIDs,omitempty"`    // 被踢用户ID列表
	Reason        string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`                  // 踢人原因
	SendMessage   *bool                  `protobuf:"varint,4,opt,name=sendMessage,proto3,oneof" json:"sendMessage,omitempty"` // 是否发送通知消息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetJoinedGroupListReq struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Pagination    *sdkws.RequestPagination `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"` // 分页参数
	FromUserID    string                   `protobuf:"bytes,2,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"` // 用户ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetJoinedGroupListResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         uint32                 `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`  // 总数
	Groups        []*sdkws.GroupInfo     `protobuf:"bytes,2,rep,name=groups,proto3" json:"groups,omitempty"` // 群组列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type InviteUserToGroupReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	GroupID        string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`                // 群组ID
	Reason         string                 `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"`                  // 邀请理由
	InvitedUserIDs []string               `protobuf:"bytes,3,rep,name=invitedUserIDs,proto3" json:"invitedUserIDs,omitempty"`  // 被邀请用户ID列表
	SendMessage    *bool                  `protobuf:"varint,4,opt,name=sendMessage,proto3,oneof" json:"sendMessage,omitempty"` // 是否发送通知消息
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GetGroupAllMemberResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Members       []*sdkws.GroupMemberFullInfo `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"` // 群成员列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMSGroup struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	GroupInfo          *sdkws.GroupInfo       `protobuf:"bytes,1,opt,name=groupInfo,proto3" json:"groupInfo,omitempty"`                   // 群组信息
	GroupOwnerUserName string                 `protobuf:"bytes,2,opt,name=groupOwnerUserName,proto3" json:"groupOwnerUserName,omitempty"` // 群主用户名
	GroupOwnerUserID   string                 `protobuf:"bytes,3,opt,name=groupOwnerUserID,proto3" json:"groupOwnerUserID,omitempty"`     // 群主用户ID
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type GetGroupsReq struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Pagination    *sdkws.RequestPagination `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"` // 分页参数
	GroupName     string                   `protobuf:"bytes,2,opt,name=groupName,proto3" json:"groupName,omitempty"`   // 群名称(可选，用于搜索)
	GroupID       string                   `protobuf:"bytes,3,opt,name=groupID,proto3" json:"groupID,omitempty"`       // 群组ID(可选，用于精确查找)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         uint32                 `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`  // 总数
	Groups        []*CMSGroup            `protobuf:"bytes,2,rep,name=groups,proto3" json:"groups,omitempty"` // 群组列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMembersCMSReq struct {
	...
	Pagination    *sdkws.RequestPagination `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"` // 分页参数
	GroupID       string                   `protobuf:"bytes,2,opt,name=groupID,proto3" json:"groupID,omitempty"`       // 群组ID
	UserName      string                   `protobuf:"bytes,3,opt,name=userName,proto3" json:"userName,omitempty"`     // 用户名(可选，用于搜索)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DismissGroupReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`                // 群组ID
	DeleteMember  bool                   `protobuf:"varint,2,opt,name=deleteMember,proto3" json:"deleteMember,omitempty"`     // 是否删除成员记录
	SendMessage   *bool                  `protobuf:"varint,3,opt,name=sendMessage,proto3,oneof" json:"sendMessage,omitempty"` // 是否发送通知消息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MuteGroupMemberReq struct {
	...
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`            // 群组ID
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`              // 用户ID
	MutedSeconds  uint32                 `protobuf:"varint,3,opt,name=mutedSeconds,proto3" json:"mutedSeconds,omitempty"` // 禁言时长(秒)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetGroupMemberInfo struct {
	...
	GroupID       string                  `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`     // 群组ID
	UserID        string                  `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`       // 用户ID
	Nickname      *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=nickname,proto3" json:"nickname,omitempty"`   // 群昵称(可选)
	FaceURL       *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=faceURL,proto3" json:"faceURL,omitempty"`     // 头像URL(可选)
	RoleLevel     *wrapperspb.Int32Value  `protobuf:"bytes,5,opt,name=roleLevel,proto3" json:"roleLevel,omitempty"` // 角色等级(可选)
	Ex            *wrapperspb.StringValue `protobuf:"bytes,6,opt,name=ex,proto3" json:"ex,omitempty"`               // 扩展字段(可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetGroupMemberInfoReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Members       []*SetGroupMemberInfo  `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"` // 群成员信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GroupAbstractInfo struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	GroupID             string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`                          // 群组ID
	GroupMemberNumber   uint32                 `protobuf:"varint,2,opt,name=groupMemberNumber,proto3" json:"groupMemberNumber,omitempty"`     // 成员数量
	GroupMemberListHash uint64                 `protobuf:"varint,3,opt,name=groupMemberListHash,proto3" json:"groupMemberListHash,omitempty"` // 成员列表哈希
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type GetGroupAbstractInfoResp struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	GroupAbstractInfos []*GroupAbstractInfo   `protobuf:"bytes,1,rep,name=groupAbstractInfos,proto3" json:"groupAbstractInfos,omitempty"` // 群组摘要信息列表
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type GetUserInGroupMembersReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`     // 用户ID
	GroupIDs      []string               `protobuf:"bytes,2,rep,name=groupIDs,proto3" json:"groupIDs,omitempty"` // 群组ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetUserInGroupMembersResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Members       []*sdkws.GroupMemberFullInfo `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"` // 成员信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMemberUserIDsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserIDs       []string               `protobuf:"bytes,1,rep,name=userIDs,proto3" json:"userIDs,omitempty"` // 用户ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMemberRoleLevelReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`               // 群组ID
	RoleLevels    []int32                `protobuf:"varint,2,rep,packed,name=roleLevels,proto3" json:"roleLevels,omitempty"` // 角色等级列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMemberCacheReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`             // 群组ID
	GroupMemberID string                 `protobuf:"bytes,2,opt,name=groupMemberID,proto3" json:"groupMemberID,omitempty"` // 群成员ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetGroupMemberCacheResp struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Member        *sdkws.GroupMemberFullInfo `protobuf:"bytes,1,opt,name=member,proto3" json:"member,omitempty"` // 群成员信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GroupCreateCountResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         int64                  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`                                                                           // 总群数
	Before        int64                  `protobuf:"varint,2,opt,name=before,proto3" json:"before,omitempty"`                                                                         // 开始时间前的群数
	Count         map[string]int64       `protobuf:"bytes,3,rep,name=count,proto3" json:"count,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 时间段内每日创建数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type NotificationUserInfoUpdateReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`           // 用户ID
	OldUserInfo   *sdkws.UserInfo        `protobuf:"bytes,2,opt,name=oldUserInfo,proto3" json:"oldUserInfo,omitempty"` // 旧用户信息
	NewUserInfo   *sdkws.UserInfo        `protobuf:"bytes,3,opt,name=newUserInfo,proto3" json:"newUserInfo,omitempty"` // 新用户信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetIncrementalGroupMemberReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupID       string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID,omitempty"`     // 群组ID
	VersionID     string                 `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"` // 版本ID
	Version       uint64                 `protobuf:"varint,3,opt,name=version,proto3" json:"version,omitempty"`    // 版本号
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetIncrementalGroupMemberResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Version       uint64                       `protobuf:"varint,1,opt,name=version,proto3" json:"version,omitempty"`         // 当前版本号
	VersionID     string                       `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"`      // 当前版本ID
	Full          bool                         `protobuf:"varint,3,opt,name=full,proto3" json:"full,omitempty"`               // 是否需要全量同步
	Delete        []string                     `protobuf:"bytes,4,rep,name=delete,proto3" json:"delete,omitempty"`            // 删除的成员ID列表
	Insert        []*sdkws.GroupMemberFullInfo `protobuf:"bytes,5,rep,name=insert,proto3" json:"insert,omitempty"`            // 新增的成员列表
	Update        []*sdkws.GroupMemberFullInfo `protobuf:"bytes,6,rep,name=update,proto3" json:"update,omitempty"`            // 更新的成员列表
	Group         *sdkws.GroupInfo             `protobuf:"bytes,7,opt,name=group,proto3" json:"group,omitempty"`              // 群组信息
	SortVersion   uint64                       `protobuf:"varint,8,opt,name=sortVersion,proto3" json:"sortVersion,omitempty"` // 排序版本
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetIncrementalJoinGroupResp struct {
	...
	VersionID     string                 `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"`      // 当前版本ID
	Full          bool                   `protobuf:"varint,3,opt,name=full,proto3" json:"full,omitempty"`               // 是否需要全量同步
	Delete        []string               `protobuf:"bytes,4,rep,name=delete,proto3" json:"delete,omitempty"`            // 退出的群组ID列表
	Insert        []*sdkws.GroupInfo     `protobuf:"bytes,5,rep,name=insert,proto3" json:"insert,omitempty"`            // 新增的群组列表
	Update        []*sdkws.GroupInfo     `protobuf:"bytes,6,rep,name=update,proto3" json:"update,omitempty"`            // 更新的群组列表
	SortVersion   uint64                 `protobuf:"varint,7,opt,name=sortVersion,proto3" json:"sortVersion,omitempty"` // 排序版本
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetFullGroupMemberUserIDsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IdHash        uint64                 `protobuf:"varint,1,opt,name=idHash,proto3" json:"idHash,omitempty"`  // ID哈希值
	GroupID       string                 `protobuf:"bytes,2,opt,name=groupID,proto3" json:"groupID,omitempty"` // 群组ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetFullGroupMemberUserIDsResp struct {
	...
	VersionID     string                 `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"` // 版本ID
	Equal         bool                   `protobuf:"varint,3,opt,name=equal,proto3" json:"equal,omitempty"`        // 哈希是否相等
	UserIDs       []string               `protobuf:"bytes,4,rep,name=userIDs,proto3" json:"userIDs,omitempty"`     // 成员ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetFullJoinGroupIDsResp struct {
	...
	VersionID     string                 `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"` // 版本ID
	Equal         bool                   `protobuf:"varint,3,opt,name=equal,proto3" json:"equal,omitempty"`        // 哈希是否相等
	GroupIDs      []string               `protobuf:"bytes,4,rep,name=groupIDs,proto3" json:"groupIDs,omitempty"`   // 群组ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BatchGetIncrementalGroupMemberReq struct {
	state         protoimpl.MessageState          `protogen:"open.v1"`
	UserID        string                          `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`   // 用户ID
	ReqList       []*GetIncrementalGroupMemberReq `protobuf:"bytes,2,rep,name=reqList,proto3" json:"reqList,omitempty"` // 请求列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BatchGetIncrementalGroupMemberResp struct {
	state         protoimpl.MessageState                    `protogen:"open.v1"`
	RespList      map[string]*GetIncrementalGroupMemberResp `protobuf:"bytes,1,rep,name=respList,proto3" json:"respList,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 响应列表(key为groupID)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IsGroupMemberResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsMember      bool                   `protobuf:"varint,1,opt,name=isMember,proto3" json:"isMember,omitempty"` // 是否为群成员
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_group_group_proto_rawDesc = "" +
	...
	"\x10SetGroupInfoResp\"\xbc\x04\n" +
	"\x11SetGroupInfoExReq\x12\x18\n" +
	"\agroupID\x18\x01 \x01(\tR\agroupID\x12<\n" +
	"\tgroupName\x18\x02 \x01(\v2\x1e.openim.wrapperspb.StringValueR\tgroupName\x12B\n" +
	"\fnotification\x18\x03 \x01(\v2\x1e.openim.wrapperspb.StringValueR\fnotification\x12B\n" +
	"\fintroduction\x18\x04 \x01(\v2\x1e.openim.wrapperspb.StringValueR\fintroduction\x128\n" +
	"\afaceURL\x18\x05 \x01(\v2\x1e.openim.wrapperspb.StringValueR\afaceURL\x12.\n" +
	...
	"\x11applyMemberFriend\x18\t \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\x11applyMemberFriend\"\x14\n" +
	...
	"\x13CancelMuteGroupResp\"\xa9\x02\n" +
	"\x12SetGroupMemberInfo\x12\x18\n" +
	"\agroupID\x18\x01 \x01(\tR\agroupID\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\tR\x06userID\x12:\n" +
	"\bnickname\x18\x03 \x01(\v2\x1e.openim.wrapperspb.StringValueR\bnickname\x128\n" +
	"\afaceURL\x18\x04 \x01(\v2\x1e.openim.wrapperspb.StringValueR\afaceURL\x12;\n" +
	"\troleLevel\x18\x05 \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\troleLevel\x12.\n" +
	"\x02ex\x18\x06 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\"S\n" +
	...
	"\x05value\x18\x02 \x01(\v2+.openim.group.getIncrementalGroupMemberRespR\x05value:\x028\x01\"D\n" +
	"\x10IsGroupMemberReq\x12\x18\n" +
	"\agroupID\x18\x01 \x01(\tR\agroupID\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\tR\x06userID\"/\n" +
	"\x11IsGroupMemberResp\x12\x1a\n" +
	"\bisMember\x18\x01 \x01(\bR\bisMember2\x9f\x1f\n" +
	"\x05group\x12J\n" +
	...
	"\x13GetFullJoinGroupIDs\x12$.openim.group.GetFullJoinGroupIDsReq\x1a%.openim.group.GetFullJoinGroupIDsResp\x12P\n" +
	"\rIsGroupMember\x12\x1e.openim.group.IsGroupMemberReq\x1a\x1f.openim.group.IsGroupMemberRespB/Z-github.com/PaperMan11/goim/pkg/protocol/groupb\x06proto3"
...
var file_group_group_proto_msgTypes = make([]protoimpl.MessageInfo, 88)
var file_group_group_proto_goTypes = []any{
	...
	(*IsGroupMemberReq)(nil),                      // 84: openim.group.IsGroupMemberReq
	(*IsGroupMemberResp)(nil),                     // 85: openim.group.IsGroupMemberResp
	nil,                                           // 86: openim.group.GroupCreateCountResp.CountEntry
	nil,                                           // 87: openim.group.BatchGetIncrementalGroupMemberResp.RespListEntry
	(*sdkws.GroupInfo)(nil),                       // 88: openim.sdkws.GroupInfo
	(*sdkws.GroupInfoForSet)(nil),                 // 89: openim.sdkws.GroupInfoForSet
	(*wrapperspb.StringValue)(nil),                // 90: openim.wrapperspb.StringValue
	(*wrapperspb.Int32Value)(nil),                 // 91: openim.wrapperspb.Int32Value
	(*sdkws.RequestPagination)(nil),               // 92: openim.sdkws.RequestPagination
	(*sdkws.GroupRequest)(nil),                    // 93: openim.sdkws.GroupRequest
	(*sdkws.GroupMemberFullInfo)(nil),             // 94: openim.sdkws.GroupMemberFullInfo
	(*sdkws.UserInfo)(nil),                        // 95: openim.sdkws.UserInfo
}
var file_group_group_proto_depIdxs = []int32{
	88, // 0: openim.group.CreateGroupReq.groupInfo:type_name -> openim.sdkws.GroupInfo
	88, // 1: openim.group.CreateGroupResp.groupInfo:type_name -> openim.sdkws.GroupInfo
	88, // 2: openim.group.GetGroupsInfoResp.groupInfos:type_name -> openim.sdkws.GroupInfo
	89, // 3: openim.group.SetGroupInfoReq.groupInfoForSet:type_name -> openim.sdkws.GroupInfoForSet
	90, // 4: openim.group.SetGroupInfoExReq.groupName:type_name -> openim.wrapperspb.StringValue
	90, // 5: openim.group.SetGroupInfoExReq.notification:type_name -> openim.wrapperspb.StringValue
	90, // 6: openim.group.SetGroupInfoExReq.introduction:type_name -> openim.wrapperspb.StringValue
	90, // 7: openim.group.SetGroupInfoExReq.faceURL:type_name -> openim.wrapperspb.StringValue
	90, // 8: openim.group.SetGroupInfoExReq.ex:type_name -> openim.wrapperspb.StringValue
	91, // 9: openim.group.SetGroupInfoExReq.needVerification:type_name -> openim.wrapperspb.Int32Value
	91, // 10: openim.group.SetGroupInfoExReq.lookMemberInfo:type_name -> openim.wrapperspb.Int32Value
	91, // 11: openim.group.SetGroupInfoExReq.applyMemberFriend:type_name -> openim.wrapperspb.Int32Value
	92, // 12: openim.group.GetGroupApplicationListReq.pagination:type_name -> openim.sdkws.RequestPagination
	93, // 13: openim.group.GetGroupApplicationListResp.groupRequests:type_name -> openim.sdkws.GroupRequest
	92, // 14: openim.group.GetUserReqApplicationListReq.pagination:type_name -> openim.sdkws.RequestPagination
	93, // 15: openim.group.GetUserReqApplicationListResp.groupRequests:type_name -> openim.sdkws.GroupRequest
	93, // 16: openim.group.GetSpecifiedUserGroupRequestInfoResp.groupRequests:type_name -> openim.sdkws.GroupRequest
	92, // 17: openim.group.GetGroupMemberListReq.pagination:type_name -> openim.sdkws.RequestPagination
	94, // 18: openim.group.GetGroupMemberListResp.members:type_name -> openim.sdkws.GroupMemberFullInfo
	94, // 19: openim.group.GetGroupMembersInfoResp.members:type_name -> openim.sdkws.GroupMemberFullInfo
	92, // 20: openim.group.GetJoinedGroupListReq.pagination:type_name -> openim.sdkws.RequestPagination
	88, // 21: openim.group.GetJoinedGroupListResp.groups:type_name -> openim.sdkws.GroupInfo
	92, // 22: openim.group.GetGroupAllMemberReq.pagination:type_name -> openim.sdkws.RequestPagination
	94, // 23: openim.group.GetGroupAllMemberResp.members:type_name -> openim.sdkws.GroupMemberFullInfo
	88, // 24: openim.group.CMSGroup.groupInfo:type_name -> openim.sdkws.GroupInfo
	92, // 25: openim.group.GetGroupsReq.pagination:type_name -> openim.sdkws.RequestPagination
	36, // 26: openim.group.GetGroupsResp.groups:type_name -> openim.group.CMSGroup
	92, // 27: openim.group.GetGroupMembersCMSReq.pagination:type_name -> openim.sdkws.RequestPagination
	94, // 28: openim.group.GetGroupMembersCMSResp.members:type_name -> openim.sdkws.GroupMemberFullInfo
	90, // 29: openim.group.SetGroupMemberInfo.nickname:type_name -> openim.wrapperspb.StringValue
	90, // 30: openim.group.SetGroupMemberInfo.faceURL:type_name -> openim.wrapperspb.StringValue
	91, // 31: openim.group.SetGroupMemberInfo.roleLevel:type_name -> openim.wrapperspb.Int32Value
	90, // 32: openim.group.SetGroupMemberInfo.ex:type_name -> openim.wrapperspb.StringValue
	...
	94, // 35: openim.group.GetUserInGroupMembersResp.members:type_name -> openim.sdkws.GroupMemberFullInfo
	94, // 36: openim.group.GetGroupMemberRoleLevelResp.members:type_name -> openim.sdkws.GroupMemberFullInfo
	88, // 37: openim.group.GetGroupInfoCacheResp.groupInfo:type_name -> openim.sdkws.GroupInfo
	94, // 38: openim.group.GetGroupMemberCacheResp.member:type_name -> openim.sdkws.GroupMemberFullInfo
	86, // 39: openim.group.GroupCreateCountResp.count:type_name -> openim.group.GroupCreateCountResp.CountEntry
	93, // 40: openim.group.getGroupUsersReqApplicationListResp.groupRequests:type_name -> openim.sdkws.GroupRequest
	95, // 41: openim.group.notificationUserInfoUpdateReq.oldUserInfo:type_name -> openim.sdkws.UserInfo
	95, // 42: openim.group.notificationUserInfoUpdateReq.newUserInfo:type_name -> openim.sdkws.UserInfo
	94, // 43: openim.group.getIncrementalGroupMemberResp.insert:type_name -> openim.sdkws.GroupMemberFullInfo
	94, // 44: openim.group.getIncrementalGroupMemberResp.update:type_name -> openim.sdkws.GroupMemberFullInfo
	88, // 45: openim.group.getIncrementalGroupMemberResp.group:type_name -> openim.sdkws.GroupInfo
	88, // 46: openim.group.getIncrementalJoinGroupResp.insert:type_name -> openim.sdkws.GroupInfo
	88, // 47: openim.group.getIncrementalJoinGroupResp.update:type_name -> openim.sdkws.GroupInfo
	74, // 48: openim.group.BatchGetIncrementalGroupMemberReq.reqList:type_name -> openim.group.getIncrementalGroupMemberReq
	87, // 49: openim.group.BatchGetIncrementalGroupMemberResp.respList:type_name -> openim.group.BatchGetIncrementalGroupMemberResp.RespListEntry
	...
	84, // 90: openim.group.group.IsGroupMember:input_type -> openim.group.IsGroupMemberReq
	1,  // 91: openim.group.group.createGroup:output_type -> openim.group.CreateGroupResp
	19, // 92: openim.group.group.joinGroup:output_type -> openim.group.JoinGroupResp
	23, // 93: openim.group.group.quitGroup:output_type -> openim.group.QuitGroupResp
	...
	11, // 98: openim.group.group.getGroupApplicationUnhandledCount:output_type -> openim.group.GetGroupApplicationUnhandledCountResp
	13, // 99: openim.group.group.getUserReqApplicationList:output_type -> openim.group.GetUserReqApplicationListResp
	71, // 100: openim.group.group.getGroupUsersReqApplicationList:output_type -> openim.group.getGroupUsersReqApplicationListResp
	15, // 101: openim.group.group.getSpecifiedUserGroupRequestInfo:output_type -> openim.group.GetSpecifiedUserGroupRequestInfoResp
	17, // 102: openim.group.group.transferGroupOwner:output_type -> openim.group.TransferGroupOwnerResp
	21, // 103: openim.group.group.groupApplicationResponse:output_type -> openim.group.GroupApplicationResponseResp
	25, // 104: openim.group.group.getGroupMemberList:output_type -> openim.group.GetGroupMemberListResp
	27, // 105: openim.group.group.getGroupMembersInfo:output_type -> openim.group.GetGroupMembersInfoResp
	29, // 106: openim.group.group.kickGroupMember:output_type -> openim.group.KickGroupMemberResp
	31, // 107: openim.group.group.getJoinedGroupList:output_type -> openim.group.GetJoinedGroupListResp
	33, // 108: openim.group.group.inviteUserToGroup:output_type -> openim.group.InviteUserToGroupResp
	38, // 109: openim.group.group.getGroups:output_type -> openim.group.GetGroupsResp
	41, // 110: openim.group.group.getGroupMembersCMS:output_type -> openim.group.GetGroupMembersCMSResp
	43, // 111: openim.group.group.dismissGroup:output_type -> openim.group.DismissGroupResp
	45, // 112: openim.group.group.muteGroupMember:output_type -> openim.group.MuteGroupMemberResp
	47, // 113: openim.group.group.cancelMuteGroupMember:output_type -> openim.group.CancelMuteGroupMemberResp
	49, // 114: openim.group.group.muteGroup:output_type -> openim.group.MuteGroupResp
	51, // 115: openim.group.group.cancelMuteGroup:output_type -> openim.group.CancelMuteGroupResp
	54, // 116: openim.group.group.setGroupMemberInfo:output_type -> openim.group.SetGroupMemberInfoResp
	57, // 117: openim.group.group.getGroupAbstractInfo:output_type -> openim.group.GetGroupAbstractInfoResp
	59, // 118: openim.group.group.getUserInGroupMembers:output_type -> openim.group.GetUserInGroupMembersResp
	61, // 119: openim.group.group.getGroupMemberUserIDs:output_type -> openim.group.GetGroupMemberUserIDsResp
	63, // 120: openim.group.group.GetGroupMemberRoleLevel:output_type -> openim.group.GetGroupMemberRoleLevelResp
	65, // 121: openim.group.group.GetGroupInfoCache:output_type -> openim.group.GetGroupInfoCacheResp
	67, // 122: openim.group.group.GetGroupMemberCache:output_type -> openim.group.GetGroupMemberCacheResp
	69, // 123: openim.group.group.GroupCreateCount:output_type -> openim.group.GroupCreateCountResp
	73, // 124: openim.group.group.NotificationUserInfoUpdate:output_type -> openim.group.notificationUserInfoUpdateResp
	75, // 125: openim.group.group.getIncrementalGroupMember:output_type -> openim.group.getIncrementalGroupMemberResp
	83, // 126: openim.group.group.BatchGetIncrementalGroupMember:output_type -> openim.group.BatchGetIncrementalGroupMemberResp
	77, // 127: openim.group.group.getIncrementalJoinGroup:output_type -> openim.group.getIncrementalJoinGroupResp
	79, // 128: openim.group.group.GetFullGroupMemberUserIDs:output_type -> openim.group.GetFullGroupMemberUserIDsResp
	81, // 129: openim.group.group.GetFullJoinGroupIDs:output_type -> openim.group.GetFullJoinGroupIDsResp
	85, // 130: openim.group.group.IsGroupMember:output_type -> openim.group.IsGroupMemberResp
