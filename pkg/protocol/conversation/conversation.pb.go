...
type Conversation struct {
	...
	OwnerUserID           string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`                       // 会话所有者ID
	ConversationID        string                 `protobuf:"bytes,2,opt,name=conversationID,proto3" json:"conversationID,omitempty"`                 // 会话ID
	RecvMsgOpt            int32                  `protobuf:"varint,3,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`                        // 消息接收选项(0-接收, 1-不接收, 2-接收但不通知)
	ConversationType      int32                  `protobuf:"varint,4,opt,name=conversationType,proto3" json:"conversationType,omitempty"`            // 会话类型(1-单聊, 2-群聊)
	UserID                string                 `protobuf:"bytes,5,opt,name=userID,proto3" json:"userID,omitempty"`                                 // 对方用户ID(单聊)
	GroupID               string                 `protobuf:"bytes,6,opt,name=groupID,proto3" json:"groupID,omitempty"`                               // 群组ID(群聊)
	IsPinned              bool                   `protobuf:"varint,7,opt,name=isPinned,proto3" json:"isPinned,omitempty"`                            // 是否置顶
	AttachedInfo          string                 `protobuf:"bytes,8,opt,name=attachedInfo,proto3" json:"attachedInfo,omitempty"`                     // 附加信息
	IsPrivateChat         bool                   `protobuf:"varint,9,opt,name=isPrivateChat,proto3" json:"isPrivateChat,omitempty"`                  // 是否私聊
	GroupAtType           int32                  `protobuf:"varint,10,opt,name=groupAtType,proto3" json:"groupAtType,omitempty"`                     // 群@类型(0-普通, 1-@我, 2-@所有人, 3-@我和@所有人)
	Ex                    string                 `protobuf:"bytes,11,opt,name=ex,proto3" json:"ex,omitempty"`                                        // 扩展字段
	BurnDuration          int32                  `protobuf:"varint,12,opt,name=burnDuration,proto3" json:"burnDuration,omitempty"`                   // 阅后即焚时长(秒)
	MinSeq                int64                  `protobuf:"varint,13,opt,name=minSeq,proto3" json:"minSeq,omitempty"`                               // 最小消息序列号
	MaxSeq                int64                  `protobuf:"varint,14,opt,name=maxSeq,proto3" json:"maxSeq,omitempty"`                               // 最大消息序列号
	MsgDestructTime       int64                  `protobuf:"varint,15,opt,name=msgDestructTime,proto3" json:"msgDestructTime,omitempty"`             // 消息销毁时间戳
	LatestMsgDestructTime int64                  `protobuf:"varint,16,opt,name=latestMsgDestructTime,proto3" json:"latestMsgDestructTime,omitempty"` // 最新消息销毁时间戳
	IsMsgDestruct         bool                   `protobuf:"varint,17,opt,name=isMsgDestruct,proto3" json:"isMsgDestruct,omitempty"`                 // 是否开启消息销毁
...
type ConversationReq struct {
	...
	ConversationType int32                   `protobuf:"varint,2,opt,name=conversationType,proto3" json:"conversationType,omitempty"` // 会话类型
	UserID           string                  `protobuf:"bytes,3,opt,name=userID,proto3" json:"userID,omitempty"`                      // 用户ID
	GroupID          string                  `protobuf:"bytes,4,opt,name=groupID,proto3" json:"groupID,omitempty"`                    // 群组ID
	RecvMsgOpt       *wrapperspb.Int32Value  `protobuf:"bytes,5,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`              // 消息接收选项(可选)
	IsPinned         *wrapperspb.BoolValue   `protobuf:"bytes,6,opt,name=isPinned,proto3" json:"isPinned,omitempty"`                  // 是否置顶(可选)
	AttachedInfo     *wrapperspb.StringValue `protobuf:"bytes,7,opt,name=attachedInfo,proto3" json:"attachedInfo,omitempty"`          // 附加信息(可选)
	IsPrivateChat    *wrapperspb.BoolValue   `protobuf:"bytes,8,opt,name=isPrivateChat,proto3" json:"isPrivateChat,omitempty"`        // 是否私聊(可选)
	Ex               *wrapperspb.StringValue `protobuf:"bytes,9,opt,name=ex,proto3" json:"ex,omitempty"`                              // 扩展字段(可选)
	BurnDuration     *wrapperspb.Int32Value  `protobuf:"bytes,10,opt,name=burnDuration,proto3" json:"burnDuration,omitempty"`         // 阅后即焚时长(可选)
	MinSeq           *wrapperspb.Int64Value  `protobuf:"bytes,11,opt,name=minSeq,proto3" json:"minSeq,omitempty"`                     // 最小序列号(可选)
	MaxSeq           *wrapperspb.Int64Value  `protobuf:"bytes,12,opt,name=maxSeq,proto3" json:"maxSeq,omitempty"`                     // 最大序列号(可选)
	GroupAtType      *wrapperspb.Int32Value  `protobuf:"bytes,13,opt,name=groupAtType,proto3" json:"groupAtType,omitempty"`           // 群@类型(可选)
	MsgDestructTime  *wrapperspb.Int64Value  `protobuf:"bytes,14,opt,name=msgDestructTime,proto3" json:"msgDestructTime,omitempty"`   // 消息销毁时间(可选)
	IsMsgDestruct    *wrapperspb.BoolValue   `protobuf:"bytes,15,opt,name=isMsgDestruct,proto3" json:"isMsgDestruct,omitempty"`       // 是否开启消息销毁(可选)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type GetConversationReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	OwnerUserID    string                 `protobuf:"bytes,2,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`       // 所有者ID
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GetConversationResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Conversation  *Conversation          `protobuf:"bytes,2,opt,name=conversation,proto3" json:"conversation,omitempty"` // 会话信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetSortedConversationListReq struct {
	...
	ConversationIDs []string                 `protobuf:"bytes,2,rep,name=conversationIDs,proto3" json:"conversationIDs,omitempty"` // 会话ID列表(可选，用于过滤)
	Pagination      *sdkws.RequestPagination `protobuf:"bytes,3,opt,name=pagination,proto3" json:"pagination,omitempty"`           // 分页参数
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type GetSortedConversationListResp struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	ConversationTotal int64                  `protobuf:"varint,1,opt,name=conversationTotal,proto3" json:"conversationTotal,omitempty"` // 会话总数
	UnreadTotal       int64                  `protobuf:"varint,2,opt,name=unreadTotal,proto3" json:"unreadTotal,omitempty"`             // 未读消息总数
	ConversationElems []*ConversationElem    `protobuf:"bytes,3,rep,name=conversationElems,proto3" json:"conversationElems,omitempty"`  // 会话元素列表
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ConversationElem struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	RecvMsgOpt     int32                  `protobuf:"varint,2,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`        // 消息接收选项
	UnreadCount    int64                  `protobuf:"varint,3,opt,name=unreadCount,proto3" json:"unreadCount,omitempty"`      // 未读消息数量
	IsPinned       bool                   `protobuf:"varint,4,opt,name=IsPinned,proto3" json:"IsPinned,omitempty"`            // 是否置顶
	MsgInfo        *MsgInfo               `protobuf:"bytes,5,opt,name=msgInfo,proto3" json:"msgInfo,omitempty"`               // 最新消息摘要
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type MsgInfo struct {
	...
	SessionType       int32                  `protobuf:"varint,3,opt,name=sessionType,proto3" json:"sessionType,omitempty"`              // 会话类型
	SendID            string                 `protobuf:"bytes,4,opt,name=sendID,proto3" json:"sendID,omitempty"`                         // 发送者ID
	RecvID            string                 `protobuf:"bytes,5,opt,name=recvID,proto3" json:"recvID,omitempty"`                         // 接收者ID
	SenderName        string                 `protobuf:"bytes,6,opt,name=senderName,proto3" json:"senderName,omitempty"`                 // 发送者名称
	FaceURL           string                 `protobuf:"bytes,7,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                       // 发送者头像URL
	GroupID           string                 `protobuf:"bytes,8,opt,name=groupID,proto3" json:"groupID,omitempty"`                       // 群组ID
	GroupName         string                 `protobuf:"bytes,9,opt,name=groupName,proto3" json:"groupName,omitempty"`                   // 群组名称
	GroupFaceURL      string                 `protobuf:"bytes,10,opt,name=groupFaceURL,proto3" json:"groupFaceURL,omitempty"`            // 群组头像URL
	GroupType         int32                  `protobuf:"varint,11,opt,name=groupType,proto3" json:"groupType,omitempty"`                 // 群组类型
	GroupMemberCount  uint32                 `protobuf:"varint,12,opt,name=groupMemberCount,proto3" json:"groupMemberCount,omitempty"`   // 群成员数量
	LatestMsgRecvTime int64                  `protobuf:"varint,13,opt,name=LatestMsgRecvTime,proto3" json:"LatestMsgRecvTime,omitempty"` // 最新消息接收时间
	MsgFrom           int32                  `protobuf:"varint,14,opt,name=msgFrom,proto3" json:"msgFrom,omitempty"`                     // 消息来源
	ContentType       int32                  `protobuf:"varint,15,opt,name=contentType,proto3" json:"contentType,omitempty"`             // 消息内容类型
	Content           string                 `protobuf:"bytes,16,opt,name=content,proto3" json:"content,omitempty"`                      // 消息内容
	Ex                string                 `protobuf:"bytes,17,opt,name=ex,proto3" json:"ex,omitempty"`                                // 扩展字段
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type GetConversationsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Conversations []*Conversation        `protobuf:"bytes,2,rep,name=conversations,proto3" json:"conversations,omitempty"` // 会话列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CreateSingleChatConversationsReq struct {
	...
	ConversationID   string                 `protobuf:"bytes,3,opt,name=conversationID,proto3" json:"conversationID,omitempty"`      // 会话ID
	ConversationType int32                  `protobuf:"varint,4,opt,name=conversationType,proto3" json:"conversationType,omitempty"` // 会话类型
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type SetConversationMaxSeqReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	OwnerUserID    []string               `protobuf:"bytes,2,rep,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`       // 所有者ID列表
...
type SetConversationsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserIDs       []string               `protobuf:"bytes,1,rep,name=userIDs,proto3" json:"userIDs,omitempty"`           // 用户ID列表
	Conversation  *ConversationReq       `protobuf:"bytes,2,opt,name=conversation,proto3" json:"conversation,omitempty"` // 会话参数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetUserConversationIDsHashResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Hash          uint64                 `protobuf:"varint,1,opt,name=hash,proto3" json:"hash,omitempty"` // 哈希值
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetConversationOfflinePushUserIDsReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	UserIDs        []string               `protobuf:"bytes,2,rep,name=userIDs,proto3" json:"userIDs,omitempty"`               // 用户ID列表(用于过滤)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type UpdateConversationReq struct {
	...
	RecvMsgOpt            *wrapperspb.Int32Value  `protobuf:"bytes,3,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`                        // 消息接收选项(可选)
	IsPinned              *wrapperspb.BoolValue   `protobuf:"bytes,4,opt,name=isPinned,proto3" json:"isPinned,omitempty"`                            // 是否置顶(可选)
	AttachedInfo          *wrapperspb.StringValue `protobuf:"bytes,5,opt,name=attachedInfo,proto3" json:"attachedInfo,omitempty"`                    // 附加信息(可选)
	IsPrivateChat         *wrapperspb.BoolValue   `protobuf:"bytes,6,opt,name=isPrivateChat,proto3" json:"isPrivateChat,omitempty"`                  // 是否私聊(可选)
	Ex                    *wrapperspb.StringValue `protobuf:"bytes,7,opt,name=ex,proto3" json:"ex,omitempty"`                                        // 扩展字段(可选)
	BurnDuration          *wrapperspb.Int32Value  `protobuf:"bytes,8,opt,name=burnDuration,proto3" json:"burnDuration,omitempty"`                    // 阅后即焚时长(可选)
	MinSeq                *wrapperspb.Int64Value  `protobuf:"bytes,9,opt,name=minSeq,proto3" json:"minSeq,omitempty"`                                // 最小序列号(可选)
	MaxSeq                *wrapperspb.Int64Value  `protobuf:"bytes,10,opt,name=maxSeq,proto3" json:"maxSeq,omitempty"`                               // 最大序列号(可选)
	GroupAtType           *wrapperspb.Int32Value  `protobuf:"bytes,11,opt,name=groupAtType,proto3" json:"groupAtType,omitempty"`                     // 群@类型(可选)
	MsgDestructTime       *wrapperspb.Int64Value  `protobuf:"bytes,12,opt,name=msgDestructTime,proto3" json:"msgDestructTime,omitempty"`             // 消息销毁时间(可选)
	IsMsgDestruct         *wrapperspb.BoolValue   `protobuf:"bytes,13,opt,name=isMsgDestruct,proto3" json:"isMsgDestruct,omitempty"`                 // 是否开启消息销毁(可选)
	LatestMsgDestructTime *wrapperspb.Int64Value  `protobuf:"bytes,14,opt,name=latestMsgDestructTime,proto3" json:"latestMsgDestructTime,omitempty"` // 最新消息销毁时间(可选)
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type GetFullOwnerConversationIDsResp struct {
	...
	ConversationIDs []string               `protobuf:"bytes,4,rep,name=conversationIDs,proto3" json:"conversationIDs,omitempty"` // 会话ID列表
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type GetIncrementalConversationResp struct {
	...
	Delete        []string               `protobuf:"bytes,4,rep,name=delete,proto3" json:"delete,omitempty"`       // 删除的会话ID列表
	Insert        []*Conversation        `protobuf:"bytes,5,rep,name=insert,proto3" json:"insert,omitempty"`       // 新增的会话列表
	Update        []*Conversation        `protobuf:"bytes,6,rep,name=update,proto3" json:"update,omitempty"`       // 更新的会话列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetOwnerConversationReq struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	UserID        string                   `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`         // 用户ID
	Pagination    *sdkws.RequestPagination `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"` // 分页参数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ClearUserConversationMsgResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Count         int32                  `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"` // 清理数量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdateConversationsByUserReq struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	UserID        string                  `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"` // 用户ID
	Ex            *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=ex,proto3" json:"ex,omitempty"`         // 扩展字段(可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DeleteConversationsReq struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID     string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`         // 所有者ID
	NeedDeleteTime  int64                  `protobuf:"varint,2,opt,name=needDeleteTime,proto3" json:"needDeleteTime,omitempty"`  // 需要删除的时间
	ConversationIDs []string               `protobuf:"bytes,3,rep,name=conversationIDs,proto3" json:"conversationIDs,omitempty"` // 会话ID列表(可选)
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_conversation_conversation_proto_rawDesc = "" +
	...
	"\risMsgDestruct\x18\x11 \x01(\bR\risMsgDestruct\"\xc7\x06\n" +
	...
	"\n" +
	"recvMsgOpt\x18\x05 \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\n" +
	"recvMsgOpt\x128\n" +
	"\bisPinned\x18\x06 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\bisPinned\x12B\n" +
	"\fattachedInfo\x18\a \x01(\v2\x1e.openim.wrapperspb.StringValueR\fattachedInfo\x12B\n" +
	"\risPrivateChat\x18\b \x01(\v2\x1c.openim.wrapperspb.BoolValueR\risPrivateChat\x12.\n" +
	"\x02ex\x18\t \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\x12A\n" +
	"\fburnDuration\x18\n" +
	" \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\fburnDuration\x125\n" +
	"\x06minSeq\x18\v \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x06minSeq\x125\n" +
	"\x06maxSeq\x18\f \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x06maxSeq\x12?\n" +
	"\vgroupAtType\x18\r \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\vgroupAtType\x12G\n" +
	"\x0fmsgDestructTime\x18\x0e \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x0fmsgDestructTime\x12B\n" +
	"\risMsgDestruct\x18\x0f \x01(\v2\x1c.openim.wrapperspb.BoolValueR\risMsgDestruct\"[\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xde\x06\n" +
	"\x15UpdateConversationReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x18\n" +
	"\auserIDs\x18\x02 \x03(\tR\auserIDs\x12=\n" +
	"\n" +
	"recvMsgOpt\x18\x03 \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\n" +
	"recvMsgOpt\x128\n" +
	"\bisPinned\x18\x04 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\bisPinned\x12B\n" +
	"\fattachedInfo\x18\x05 \x01(\v2\x1e.openim.wrapperspb.StringValueR\fattachedInfo\x12B\n" +
	"\risPrivateChat\x18\x06 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\risPrivateChat\x12.\n" +
	"\x02ex\x18\a \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\x12A\n" +
	"\fburnDuration\x18\b \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\fburnDuration\x125\n" +
	"\x06minSeq\x18\t \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x06minSeq\x125\n" +
	"\x06maxSeq\x18\n" +
	" \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x06maxSeq\x12?\n" +
	"\vgroupAtType\x18\v \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\vgroupAtType\x12G\n" +
	"\x0fmsgDestructTime\x18\f \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x0fmsgDestructTime\x12B\n" +
	"\risMsgDestruct\x18\r \x01(\v2\x1c.openim.wrapperspb.BoolValueR\risMsgDestruct\x12S\n" +
	"\x15latestMsgDestructTime\x18\x0e \x01(\v2\x1d.openim.wrapperspb.Int64ValueR\x15latestMsgDestructTime\"\x18\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12.\n" +
	"\x02ex\x18\x02 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\"\x1f\n" +
	...
	"\x13DeleteConversations\x12+.openim.conversation.DeleteConversationsReq\x1a,.openim.conversation.DeleteConversationsRespB6Z4github.com/PaperMan11/goim/pkg/protocol/conversationb\x06proto3"
...
var file_conversation_conversation_proto_goTypes = []any{
	...
	(*wrapperspb.Int32Value)(nil),                       // 56: openim.wrapperspb.Int32Value
	(*wrapperspb.BoolValue)(nil),                        // 57: openim.wrapperspb.BoolValue
	(*wrapperspb.StringValue)(nil),                      // 58: openim.wrapperspb.StringValue
	(*wrapperspb.Int64Value)(nil),                       // 59: openim.wrapperspb.Int64Value
	(*sdkws.RequestPagination)(nil),                     // 60: openim.sdkws.RequestPagination
}
var file_conversation_conversation_proto_depIdxs = []int32{
	56, // 0: openim.conversation.ConversationReq.recvMsgOpt:type_name -> openim.wrapperspb.Int32Value
	57, // 1: openim.conversation.ConversationReq.isPinned:type_name -> openim.wrapperspb.BoolValue
	58, // 2: openim.conversation.ConversationReq.attachedInfo:type_name -> openim.wrapperspb.StringValue
	57, // 3: openim.conversation.ConversationReq.isPrivateChat:type_name -> openim.wrapperspb.BoolValue
	58, // 4: openim.conversation.ConversationReq.ex:type_name -> openim.wrapperspb.StringValue
	56, // 5: openim.conversation.ConversationReq.burnDuration:type_name -> openim.wrapperspb.Int32Value
	59, // 6: openim.conversation.ConversationReq.minSeq:type_name -> openim.wrapperspb.Int64Value
	59, // 7: openim.conversation.ConversationReq.maxSeq:type_name -> openim.wrapperspb.Int64Value
	56, // 8: openim.conversation.ConversationReq.groupAtType:type_name -> openim.wrapperspb.Int32Value
	59, // 9: openim.conversation.ConversationReq.msgDestructTime:type_name -> openim.wrapperspb.Int64Value
	57, // 10: openim.conversation.ConversationReq.isMsgDestruct:type_name -> openim.wrapperspb.BoolValue
	...
	56, // 20: openim.conversation.UpdateConversationReq.recvMsgOpt:type_name -> openim.wrapperspb.Int32Value
	57, // 21: openim.conversation.UpdateConversationReq.isPinned:type_name -> openim.wrapperspb.BoolValue
	58, // 22: openim.conversation.UpdateConversationReq.attachedInfo:type_name -> openim.wrapperspb.StringValue
	57, // 23: openim.conversation.UpdateConversationReq.isPrivateChat:type_name -> openim.wrapperspb.BoolValue
	58, // 24: openim.conversation.UpdateConversationReq.ex:type_name -> openim.wrapperspb.StringValue
	56, // 25: openim.conversation.UpdateConversationReq.burnDuration:type_name -> openim.wrapperspb.Int32Value
	59, // 26: openim.conversation.UpdateConversationReq.minSeq:type_name -> openim.wrapperspb.Int64Value
	59, // 27: openim.conversation.UpdateConversationReq.maxSeq:type_name -> openim.wrapperspb.Int64Value
	56, // 28: openim.conversation.UpdateConversationReq.groupAtType:type_name -> openim.wrapperspb.Int32Value
	59, // 29: openim.conversation.UpdateConversationReq.msgDestructTime:type_name -> openim.wrapperspb.Int64Value
	57, // 30: openim.conversation.UpdateConversationReq.isMsgDestruct:type_name -> openim.wrapperspb.BoolValue
	59, // 31: openim.conversation.UpdateConversationReq.latestMsgDestructTime:type_name -> openim.wrapperspb.Int64Value
	...
	58, // 37: openim.conversation.UpdateConversationsByUserReq.ex:type_name -> openim.wrapperspb.StringValue
