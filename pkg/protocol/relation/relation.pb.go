...
type GetPaginationFriendsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FriendsInfo   []*sdkws.FriendInfo    `protobuf:"bytes,1,rep,name=friendsInfo,proto3" json:"friendsInfo,omitempty"` // 好友信息列表
...
type ApplyToAddFriendReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromUserID    string                 `protobuf:"bytes,1,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"` // 请求发起者ID
	ToUserID      string                 `protobuf:"bytes,2,opt,name=toUserID,proto3" json:"toUserID,omitempty"`     // 请求接收者ID
	ReqMsg        string                 `protobuf:"bytes,3,opt,name=reqMsg,proto3" json:"reqMsg,omitempty"`         // 请求消息
...
type FriendInfo struct {
	...
	FriendUserID   string                 `protobuf:"bytes,2,opt,name=friendUserID,proto3" json:"friendUserID,omitempty"`     // 好友ID
	FriendNickname string                 `protobuf:"bytes,3,opt,name=friendNickname,proto3" json:"friendNickname,omitempty"` // 好友昵称
	FriendFaceURL  string                 `protobuf:"bytes,4,opt,name=friendFaceURL,proto3" json:"friendFaceURL,omitempty"`   // 好友头像URL
	...
	AddSource      int32                  `protobuf:"varint,7,opt,name=addSource,proto3" json:"addSource,omitempty"`          // 添加来源
	OperatorUserID string                 `protobuf:"bytes,8,opt,name=operatorUserID,proto3" json:"operatorUserID,omitempty"` // 操作者ID
	Ex             string                 `protobuf:"bytes,9,opt,name=ex,proto3" json:"ex,omitempty"`                         // 扩展字段
	IsPinned       bool                   `protobuf:"varint,10,opt,name=isPinned,proto3" json:"isPinned,omitempty"`           // 是否置顶
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ImportFriendReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID   string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`     // 所有者ID
	FriendUserIDs []string               `protobuf:"bytes,2,rep,name=friendUserIDs,proto3" json:"friendUserIDs,omitempty"` // 好友ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPaginationFriendsApplyToReq struct {
	...
	HandleResults []int32                  `protobuf:"varint,3,rep,packed,name=handleResults,proto3" json:"handleResults,omitempty"` // 处理结果过滤(可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPaginationFriendsApplyToResp struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	FriendRequests []*sdkws.FriendRequest `protobuf:"bytes,1,rep,name=FriendRequests,proto3" json:"FriendRequests,omitempty"` // 好友申请列表
	Total          int32                  `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`                  // 总数
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GetIncrementalFriendsApplyToResp struct {
	...
	DeleteUserIds []string               `protobuf:"bytes,4,rep,name=deleteUserIds,proto3" json:"deleteUserIds,omitempty"` // 删除的用户ID列表
	Changes       []*sdkws.FriendRequest `protobuf:"bytes,5,rep,name=changes,proto3" json:"changes,omitempty"`             // 变更的好友申请列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AddBlackReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID   string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"` // 所有者ID
	BlackUserID   string                 `protobuf:"bytes,2,opt,name=blackUserID,proto3" json:"blackUserID,omitempty"` // 被拉黑用户ID
...
type RemoveBlackReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID   string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"` // 所有者ID
	BlackUserID   string                 `protobuf:"bytes,2,opt,name=blackUserID,proto3" json:"blackUserID,omitempty"` // 被移除用户ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPaginationBlacksResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Blacks        []*sdkws.BlackInfo     `protobuf:"bytes,1,rep,name=blacks,proto3" json:"blacks,omitempty"` // 黑名单列表
	Total         int32                  `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`  // 总数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IsFriendResp struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	InUser1Friends bool                   `protobuf:"varint,1,opt,name=inUser1Friends,proto3" json:"inUser1Friends,omitempty"` // userID2是否在userID1的好友列表中
	InUser2Friends bool                   `protobuf:"varint,2,opt,name=inUser2Friends,proto3" json:"inUser2Friends,omitempty"` // userID1是否在userID2的好友列表中
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type IsBlackResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InUser1Blacks bool                   `protobuf:"varint,1,opt,name=inUser1Blacks,proto3" json:"inUser1Blacks,omitempty"` // userID2是否在userID1的黑名单中
	InUser2Blacks bool                   `protobuf:"varint,2,opt,name=inUser2Blacks,proto3" json:"inUser2Blacks,omitempty"` // userID1是否在userID2的黑名单中
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RespondFriendApplyReq struct {
	...
	FromUserID    string                 `protobuf:"bytes,1,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"`      // 请求发起者ID
	ToUserID      string                 `protobuf:"bytes,2,opt,name=toUserID,proto3" json:"toUserID,omitempty"`          // 请求接收者ID
	HandleResult  int32                  `protobuf:"varint,3,opt,name=handleResult,proto3" json:"handleResult,omitempty"` // 处理结果(1-同意, 2-拒绝)
...
type UpdateFriendsReq struct {
	...
	OwnerUserID   string                  `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`     // 所有者ID
	FriendUserIDs []string                `protobuf:"bytes,2,rep,name=friendUserIDs,proto3" json:"friendUserIDs,omitempty"` // 好友ID列表
	IsPinned      *wrapperspb.BoolValue   `protobuf:"bytes,3,opt,name=isPinned,proto3" json:"isPinned,omitempty"`           // 是否置顶(可选)
	Remark        *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=remark,proto3" json:"remark,omitempty"`               // 备注(可选)
...
type GetFriendIDsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FriendIDs     []string               `protobuf:"bytes,1,rep,name=friendIDs,proto3" json:"friendIDs,omitempty"` // 好友ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetSpecifiedFriendsInfoInfo struct {
	...
	FriendInfo    *sdkws.FriendInfo      `protobuf:"bytes,2,opt,name=friendInfo,proto3" json:"friendInfo,omitempty"` // 好友信息(如果是好友)
	BlackInfo     *sdkws.BlackInfo       `protobuf:"bytes,3,opt,name=blackInfo,proto3" json:"blackInfo,omitempty"`   // 黑名单信息(如果在黑名单)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetSpecifiedFriendsInfoResp struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Infos         []*GetSpecifiedFriendsInfoInfo `protobuf:"bytes,1,rep,name=infos,proto3" json:"infos,omitempty"` // 用户详细信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetIncrementalFriendsResp struct {
	...
	VersionID     string                 `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"`      // 当前版本ID
	Full          bool                   `protobuf:"varint,3,opt,name=full,proto3" json:"full,omitempty"`               // 是否需要全量同步
	Delete        []string               `protobuf:"bytes,4,rep,name=delete,proto3" json:"delete,omitempty"`            // 删除的好友ID列表
	Insert        []*sdkws.FriendInfo    `protobuf:"bytes,5,rep,name=insert,proto3" json:"insert,omitempty"`            // 新增的好友列表
	Update        []*sdkws.FriendInfo    `protobuf:"bytes,6,rep,name=update,proto3" json:"update,omitempty"`            // 更新的好友列表
...
type GetIncrementalBlacksResp struct {
	...
	VersionID     string                 `protobuf:"bytes,2,opt,name=versionID,proto3" json:"versionID,omitempty"` // 当前版本ID
	Full          bool                   `protobuf:"varint,3,opt,name=full,proto3" json:"full,omitempty"`          // 是否需要全量同步
	Delete        []string               `protobuf:"bytes,4,rep,name=delete,proto3" json:"delete,omitempty"`       // 删除的黑名单ID列表
	Insert        []*sdkws.BlackInfo     `protobuf:"bytes,5,rep,name=insert,proto3" json:"insert,omitempty"`       // 新增的黑名单列表
	Update        []*sdkws.BlackInfo     `protobuf:"bytes,6,rep,name=update,proto3" json:"update,omitempty"`       // 更新的黑名单列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetSpecifiedBlacksResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Blacks        []*sdkws.BlackInfo     `protobuf:"bytes,1,rep,name=blacks,proto3" json:"blacks,omitempty"` // 黑名单信息列表
	Total         int32                  `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`  // 总数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetFullFriendUserIDsResp struct {
	...
	UserIDs       []string               `protobuf:"bytes,4,rep,name=userIDs,proto3" json:"userIDs,omitempty"`     // 好友ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendInfoOnly struct {
	...
	FriendUserID   string                 `protobuf:"bytes,2,opt,name=friendUserID,proto3" json:"friendUserID,omitempty"`     // 好友ID
	Remark         string                 `protobuf:"bytes,3,opt,name=remark,proto3" json:"remark,omitempty"`                 // 备注
	CreateTime     int64                  `protobuf:"varint,4,opt,name=createTime,proto3" json:"createTime,omitempty"`        // 创建时间戳
	AddSource      int32                  `protobuf:"varint,5,opt,name=addSource,proto3" json:"addSource,omitempty"`          // 添加来源
	OperatorUserID string                 `protobuf:"bytes,6,opt,name=operatorUserID,proto3" json:"operatorUserID,omitempty"` // 操作者ID
...
type GetFriendInfoResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FriendInfos   []*FriendInfoOnly      `protobuf:"bytes,1,rep,name=friendInfos,proto3" json:"friendInfos,omitempty"` // 好友信息列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_relation_relation_proto_rawDesc = "" +
	...
	"\x16respondFriendApplyResp\"\xfc\x01\n" +
	"\x10updateFriendsReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12$\n" +
	"\rfriendUserIDs\x18\x02 \x03(\tR\rfriendUserIDs\x128\n" +
	"\bisPinned\x18\x03 \x01(\v2\x1c.openim.wrapperspb.BoolValueR\bisPinned\x126\n" +
	"\x06remark\x18\x04 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x06remark\x12.\n" +
	"\x02ex\x18\x05 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\"\x13\n" +
	...
	"\rgetFriendInfo\x12!.openim.relation.getFriendInfoReq\x1a\".openim.relation.getFriendInfoRespB2Z0github.com/PaperMan11/goim/pkg/protocol/relationb\x06proto3"
...
var file_relation_relation_proto_goTypes = []any{
	...
	(*wrapperspb.BoolValue)(nil),               // 61: openim.wrapperspb.BoolValue
	(*wrapperspb.StringValue)(nil),             // 62: openim.wrapperspb.StringValue
...
var file_relation_relation_proto_depIdxs = []int32{
	...
	61, // 10: openim.relation.updateFriendsReq.isPinned:type_name -> openim.wrapperspb.BoolValue
	62, // 11: openim.relation.updateFriendsReq.remark:type_name -> openim.wrapperspb.StringValue
	62, // 12: openim.relation.updateFriendsReq.ex:type_name -> openim.wrapperspb.StringValue
