...
type GroupInfo struct {
	...
	GroupName              string                 `protobuf:"bytes,2,opt,name=groupName,proto3" json:"groupName,omitempty"`                             // 群组名称
	Notification           string                 `protobuf:"bytes,3,opt,name=notification,proto3" json:"notification,omitempty"`                       // 群组公告
	Introduction           string                 `protobuf:"bytes,4,opt,name=introduction,proto3" json:"introduction,omitempty"`                       // 群组介绍
	FaceURL                string                 `protobuf:"bytes,5,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                                 // 群组头像URL
	OwnerUserID            string                 `protobuf:"bytes,6,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`                         // 群主ID
	CreateTime             int64                  `protobuf:"varint,7,opt,name=createTime,proto3" json:"createTime,omitempty"`                          // 创建时间戳
	MemberCount            uint32                 `protobuf:"varint,8,opt,name=memberCount,proto3" json:"memberCount,omitempty"`                        // 成员数量
	Ex                     string                 `protobuf:"bytes,9,opt,name=ex,proto3" json:"ex,omitempty"`                                           // 扩展字段
	Status                 int32                  `protobuf:"varint,10,opt,name=status,proto3" json:"status,omitempty"`                                 // 群组状态
	CreatorUserID          string                 `protobuf:"bytes,11,opt,name=creatorUserID,proto3" json:"creatorUserID,omitempty"`                    // 创建者ID
	GroupType              int32                  `protobuf:"varint,12,opt,name=groupType,proto3" json:"groupType,omitempty"`                           // 群组类型
	NeedVerification       int32                  `protobuf:"varint,13,opt,name=needVerification,proto3" json:"needVerification,omitempty"`             // 是否需要验证(0-不需要, 1-需要)
	LookMemberInfo         int32                  `protobuf:"varint,14,opt,name=lookMemberInfo,proto3" json:"lookMemberInfo,omitempty"`                 // 是否允许查看成员信息(0-不允许, 1-允许)
	ApplyMemberFriend      int32                  `protobuf:"varint,15,opt,name=applyMemberFriend,proto3" json:"applyMemberFriend,omitempty"`           // 是否允许成员添加好友(0-不允许, 1-允许)
	NotificationUpdateTime int64                  `protobuf:"varint,16,opt,name=notificationUpdateTime,proto3" json:"notificationUpdateTime,omitempty"` // 公告更新时间戳
	NotificationUserID     string                 `protobuf:"bytes,17,opt,name=notificationUserID,proto3" json:"notificationUserID,omitempty"`          // 公告更新者ID
...
type GroupInfoForSet struct {
	...
	Introduction      string                  `protobuf:"bytes,4,opt,name=introduction,proto3" json:"introduction,omitempty"`           // 群组介绍
	FaceURL           string                  `protobuf:"bytes,5,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                     // 群组头像URL
	Ex                *wrapperspb.StringValue `protobuf:"bytes,6,opt,name=ex,proto3" json:"ex,omitempty"`                               // 扩展字段(可选)
	NeedVerification  *wrapperspb.Int32Value  `protobuf:"bytes,7,opt,name=needVerification,proto3" json:"needVerification,omitempty"`   // 是否需要验证(可选)
	LookMemberInfo    *wrapperspb.Int32Value  `protobuf:"bytes,8,opt,name=lookMemberInfo,proto3" json:"lookMemberInfo,omitempty"`       // 是否允许查看成员信息(可选)
	ApplyMemberFriend *wrapperspb.Int32Value  `protobuf:"bytes,9,opt,name=applyMemberFriend,proto3" json:"applyMemberFriend,omitempty"` // 是否允许成员添加好友(可选)
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type GroupMemberFullInfo struct {
	...
	RoleLevel      int32                  `protobuf:"varint,3,opt,name=roleLevel,proto3" json:"roleLevel,omitempty"`           // 角色等级(100-群主, 60-管理员, 20-普通成员)
	JoinTime       int64                  `protobuf:"varint,4,opt,name=joinTime,proto3" json:"joinTime,omitempty"`             // 加入时间戳
	Nickname       string                 `protobuf:"bytes,5,opt,name=nickname,proto3" json:"nickname,omitempty"`              // 群昵称
	FaceURL        string                 `protobuf:"bytes,6,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                // 头像URL
	AppMangerLevel int32                  `protobuf:"varint,7,opt,name=appMangerLevel,proto3" json:"appMangerLevel,omitempty"` // 应用管理员等级(>0表示管理员)
	...
	Ex             string                 `protobuf:"bytes,10,opt,name=ex,proto3" json:"ex,omitempty"`                         // 扩展字段
	MuteEndTime    int64                  `protobuf:"varint,11,opt,name=muteEndTime,proto3" json:"muteEndTime,omitempty"`      // 禁言结束时间(0表示未禁言)
	InviterUserID  string                 `protobuf:"bytes,12,opt,name=inviterUserID,proto3" json:"inviterUserID,omitempty"`   // 邀请人ID
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type PublicUserInfo struct {
	...
	Ex            string                 `protobuf:"bytes,4,opt,name=ex,proto3" json:"ex,omitempty"`             // 扩展字段
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserInfo struct {
	...
	FaceURL          string                 `protobuf:"bytes,3,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                    // 头像URL
	Ex               string                 `protobuf:"bytes,4,opt,name=ex,proto3" json:"ex,omitempty"`                              // 扩展字段
	CreateTime       int64                  `protobuf:"varint,5,opt,name=createTime,proto3" json:"createTime,omitempty"`             // 创建时间戳
	AppMangerLevel   int32                  `protobuf:"varint,6,opt,name=appMangerLevel,proto3" json:"appMangerLevel,omitempty"`     // 应用管理员等级
	GlobalRecvMsgOpt int32                  `protobuf:"varint,7,opt,name=globalRecvMsgOpt,proto3" json:"globalRecvMsgOpt,omitempty"` // 全局消息接收选项
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type UserInfoWithEx struct {
	state            protoimpl.MessageState  `protogen:"open.v1"`
	UserID           string                  `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                     // 用户ID
	Nickname         *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=nickname,proto3" json:"nickname,omitempty"`                 // 昵称(可选)
	FaceURL          *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=faceURL,proto3" json:"faceURL,omitempty"`                   // 头像URL(可选)
	Ex               *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=ex,proto3" json:"ex,omitempty"`                             // 扩展字段(可选)
	GlobalRecvMsgOpt *wrapperspb.Int32Value  `protobuf:"bytes,7,opt,name=globalRecvMsgOpt,proto3" json:"globalRecvMsgOpt,omitempty"` // 全局消息接收选项(可选)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type FriendInfo struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID    string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`       // 所有者ID
	Remark         string                 `protobuf:"bytes,2,opt,name=remark,proto3" json:"remark,omitempty"`                 // 备注名
	CreateTime     int64                  `protobuf:"varint,3,opt,name=createTime,proto3" json:"createTime,omitempty"`        // 创建时间戳
	FriendUser     *UserInfo              `protobuf:"bytes,4,opt,name=friendUser,proto3" json:"friendUser,omitempty"`         // 好友用户信息
	AddSource      int32                  `protobuf:"varint,5,opt,name=addSource,proto3" json:"addSource,omitempty"`          // 添加来源
	OperatorUserID string                 `protobuf:"bytes,6,opt,name=operatorUserID,proto3" json:"operatorUserID,omitempty"` // 操作人ID
	Ex             string                 `protobuf:"bytes,7,opt,name=ex,proto3" json:"ex,omitempty"`                         // 扩展字段
	IsPinned       bool                   `protobuf:"varint,8,opt,name=isPinned,proto3" json:"isPinned,omitempty"`            // 是否置顶
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type BlackInfo struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID    string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID,omitempty"`       // 所有者ID
	CreateTime     int64                  `protobuf:"varint,2,opt,name=createTime,proto3" json:"createTime,omitempty"`        // 创建时间戳
	BlackUserInfo  *PublicUserInfo        `protobuf:"bytes,3,opt,name=blackUserInfo,proto3" json:"blackUserInfo,omitempty"`   // 黑名单用户信息
	AddSource      int32                  `protobuf:"varint,4,opt,name=addSource,proto3" json:"addSource,omitempty"`          // 添加来源
	OperatorUserID string                 `protobuf:"bytes,5,opt,name=operatorUserID,proto3" json:"operatorUserID,omitempty"` // 操作人ID
	Ex             string                 `protobuf:"bytes,6,opt,name=ex,proto3" json:"ex,omitempty"`                         // 扩展字段
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GroupRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserInfo      *PublicUserInfo        `protobuf:"bytes,1,opt,name=userInfo,proto3" json:"userInfo,omitempty"`            // 申请人信息
	GroupInfo     *GroupInfo             `protobuf:"bytes,2,opt,name=groupInfo,proto3" json:"groupInfo,omitempty"`          // 群组信息
	HandleResult  int32                  `protobuf:"varint,3,opt,name=handleResult,proto3" json:"handleResult,omitempty"`   // 处理结果(0-未处理, 1-已同意, -1-已拒绝)
	ReqMsg        string                 `protobuf:"bytes,4,opt,name=reqMsg,proto3" json:"reqMsg,omitempty"`                // 申请消息
	HandleMsg     string                 `protobuf:"bytes,5,opt,name=handleMsg,proto3" json:"handleMsg,omitempty"`          // 处理消息
	ReqTime       int64                  `protobuf:"varint,6,opt,name=reqTime,proto3" json:"reqTime,omitempty"`             // 申请时间戳
	HandleUserID  string                 `protobuf:"bytes,7,opt,name=handleUserID,proto3" json:"handleUserID,omitempty"`    // 处理人ID
	HandleTime    int64                  `protobuf:"varint,8,opt,name=handleTime,proto3" json:"handleTime,omitempty"`       // 处理时间戳
	Ex            string                 `protobuf:"bytes,9,opt,name=ex,proto3" json:"ex,omitempty"`                        // 扩展字段
	JoinSource    int32                  `protobuf:"varint,10,opt,name=joinSource,proto3" json:"joinSource,omitempty"`      // 加入来源
	InviterUserID string                 `protobuf:"bytes,11,opt,name=inviterUserID,proto3" json:"inviterUserID,omitempty"` // 邀请人ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromUserID    string                 `protobuf:"bytes,1,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"`        // 申请人ID
	FromNickname  string                 `protobuf:"bytes,2,opt,name=fromNickname,proto3" json:"fromNickname,omitempty"`    // 申请人昵称
	FromFaceURL   string                 `protobuf:"bytes,3,opt,name=fromFaceURL,proto3" json:"fromFaceURL,omitempty"`      // 申请人头像URL
	ToUserID      string                 `protobuf:"bytes,4,opt,name=toUserID,proto3" json:"toUserID,omitempty"`            // 被申请人ID
	ToNickname    string                 `protobuf:"bytes,5,opt,name=toNickname,proto3" json:"toNickname,omitempty"`        // 被申请人昵称
	ToFaceURL     string                 `protobuf:"bytes,6,opt,name=toFaceURL,proto3" json:"toFaceURL,omitempty"`          // 被申请人头像URL
	HandleResult  int32                  `protobuf:"varint,7,opt,name=handleResult,proto3" json:"handleResult,omitempty"`   // 处理结果(0-未处理, 1-已同意, -1-已拒绝)
	ReqMsg        string                 `protobuf:"bytes,8,opt,name=reqMsg,proto3" json:"reqMsg,omitempty"`                // 申请消息
	CreateTime    int64                  `protobuf:"varint,9,opt,name=createTime,proto3" json:"createTime,omitempty"`       // 创建时间戳
	HandlerUserID string                 `protobuf:"bytes,10,opt,name=handlerUserID,proto3" json:"handlerUserID,omitempty"` // 处理人ID
	HandleMsg     string                 `protobuf:"bytes,11,opt,name=handleMsg,proto3" json:"handleMsg,omitempty"`         // 处理消息
	HandleTime    int64                  `protobuf:"varint,12,opt,name=handleTime,proto3" json:"handleTime,omitempty"`      // 处理时间戳
	Ex            string                 `protobuf:"bytes,13,opt,name=ex,proto3" json:"ex,omitempty"`                       // 扩展字段
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PullMessageBySeqsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                            // 用户ID
	SeqRanges     []*SeqRange            `protobuf:"bytes,2,rep,name=seqRanges,proto3" json:"seqRanges,omitempty"`                      // 序列号范围列表
	Order         PullOrder              `protobuf:"varint,3,opt,name=order,proto3,enum=openim.sdkws.PullOrder" json:"order,omitempty"` // 拉取顺序
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SeqRange struct {
	...
	Begin          int64                  `protobuf:"varint,2,opt,name=begin,proto3" json:"begin,omitempty"`                  // 起始序列号
	End            int64                  `protobuf:"varint,3,opt,name=end,proto3" json:"end,omitempty"`                      // 结束序列号
	Num            int64                  `protobuf:"varint,4,opt,name=num,proto3" json:"num,omitempty"`                      // 数量限制
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type PullMsgs struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Msgs          []*MsgData             `protobuf:"bytes,1,rep,name=Msgs,proto3" json:"Msgs,omitempty"`      // 消息列表
	IsEnd         bool                   `protobuf:"varint,2,opt,name=isEnd,proto3" json:"isEnd,omitempty"`   // 是否到达末尾
	EndSeq        int64                  `protobuf:"varint,3,opt,name=endSeq,proto3" json:"endSeq,omitempty"` // 结束序列号
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PullMessageBySeqsResp struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Msgs             map[string]*PullMsgs   `protobuf:"bytes,1,rep,name=msgs,proto3" json:"msgs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`                         // 普通消息(会话ID -> 消息集合)
	NotificationMsgs map[string]*PullMsgs   `protobuf:"bytes,2,rep,name=notificationMsgs,proto3" json:"notificationMsgs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 通知消息(会话ID -> 消息集合)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type GetMaxSeqResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MaxSeqs       map[string]int64       `protobuf:"bytes,1,rep,name=maxSeqs,proto3" json:"maxSeqs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 各会话最大序列号
	MinSeqs       map[string]int64       `protobuf:"bytes,2,rep,name=minSeqs,proto3" json:"minSeqs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 各会话最小序列号
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserSendMsgResp struct {
	...
	SendTime      int64                  `protobuf:"varint,3,opt,name=sendTime,proto3" json:"sendTime,omitempty"`      // 发送时间戳
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MsgData struct {
	...
	GroupID          string                 `protobuf:"bytes,3,opt,name=groupID,proto3" json:"groupID,omitempty"`                                                                             // 群组ID(群消息时使用)
	...
	SenderPlatformID int32                  `protobuf:"varint,6,opt,name=senderPlatformID,proto3" json:"senderPlatformID,omitempty"`                                                          // 发送者平台ID
	SenderNickname   string                 `protobuf:"bytes,7,opt,name=senderNickname,proto3" json:"senderNickname,omitempty"`                                                               // 发送者昵称
	SenderFaceURL    string                 `protobuf:"bytes,8,opt,name=senderFaceURL,proto3" json:"senderFaceURL,omitempty"`                                                                 // 发送者头像URL
	SessionType      int32                  `protobuf:"varint,9,opt,name=sessionType,proto3" json:"sessionType,omitempty"`                                                                    // 会话类型(1-单聊, 2-群聊)
	MsgFrom          int32                  `protobuf:"varint,10,opt,name=msgFrom,proto3" json:"msgFrom,omitempty"`                                                                           // 消息来源(100-用户消息, 200-系统消息)
	ContentType      int32                  `protobuf:"varint,11,opt,name=contentType,proto3" json:"contentType,omitempty"`                                                                   // 消息内容类型
	Content          []byte                 `protobuf:"bytes,12,opt,name=content,proto3" json:"content,omitempty"`                                                                            // 消息内容(二进制)
	Seq              int64                  `protobuf:"varint,14,opt,name=seq,proto3" json:"seq,omitempty"`                                                                                   // 消息序列号
	SendTime         int64                  `protobuf:"varint,15,opt,name=sendTime,proto3" json:"sendTime,omitempty"`                                                                         // 发送时间戳
	CreateTime       int64                  `protobuf:"varint,16,opt,name=createTime,proto3" json:"createTime,omitempty"`                                                                     // 创建时间戳
	Status           int32                  `protobuf:"varint,17,opt,name=status,proto3" json:"status,omitempty"`                                                                             // 消息状态
	IsRead           bool                   `protobuf:"varint,18,opt,name=isRead,proto3" json:"isRead,omitempty"`                                                                             // 是否已读
	Options          map[string]bool        `protobuf:"bytes,19,rep,name=options,proto3" json:"options,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 消息选项
	OfflinePushInfo  *OfflinePushInfo       `protobuf:"bytes,20,opt,name=offlinePushInfo,proto3" json:"offlinePushInfo,omitempty"`                                                            // 离线推送信息
	AtUserIDList     []string               `protobuf:"bytes,21,rep,name=atUserIDList,proto3" json:"atUserIDList,omitempty"`                                                                  // @用户ID列表
...
type OfflinePushInfo struct {
	...
	Desc          string                 `protobuf:"bytes,2,opt,name=desc,proto3" json:"desc,omitempty"`                    // 推送描述
	Ex            string                 `protobuf:"bytes,3,opt,name=ex,proto3" json:"ex,omitempty"`                        // 扩展字段
	IOSPushSound  string                 `protobuf:"bytes,4,opt,name=iOSPushSound,proto3" json:"iOSPushSound,omitempty"`    // iOS推送声音
	IOSBadgeCount bool                   `protobuf:"varint,5,opt,name=iOSBadgeCount,proto3" json:"iOSBadgeCount,omitempty"` // iOS角标计数
	SignalInfo    string                 `protobuf:"bytes,6,opt,name=signalInfo,proto3" json:"signalInfo,omitempty"`        // 信令信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TipsComm struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Detail        []byte                 `protobuf:"bytes,1,opt,name=detail,proto3" json:"detail,omitempty"`           // 详细内容(二进制)
	DefaultTips   string                 `protobuf:"bytes,2,opt,name=defaultTips,proto3" json:"defaultTips,omitempty"` // 默认提示文本
	JsonDetail    string                 `protobuf:"bytes,3,opt,name=jsonDetail,proto3" json:"jsonDetail,omitempty"`   // JSON格式详细内容
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GroupCreatedTips struct {
	...
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	MemberList           []*GroupMemberFullInfo `protobuf:"bytes,3,rep,name=memberList,proto3" json:"memberList,omitempty"`                     // 成员列表
	OperationTime        int64                  `protobuf:"varint,4,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	GroupOwnerUser       *GroupMemberFullInfo   `protobuf:"bytes,5,opt,name=groupOwnerUser,proto3" json:"groupOwnerUser,omitempty"`             // 群主信息
	GroupMemberVersion   uint64                 `protobuf:"varint,6,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,7,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type GroupInfoSetTips struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,1,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	MuteTime             int64                  `protobuf:"varint,2,opt,name=muteTime,proto3" json:"muteTime,omitempty"`                        // 禁言时间
	Group                *GroupInfo             `protobuf:"bytes,3,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	GroupMemberVersion   uint64                 `protobuf:"varint,4,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,5,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type GroupInfoSetNameTips struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,1,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	Group                *GroupInfo             `protobuf:"bytes,2,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	GroupMemberVersion   uint64                 `protobuf:"varint,3,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,4,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type JoinGroupApplicationTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Group         *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`         // 群组信息
	Applicant     *PublicUserInfo        `protobuf:"bytes,2,opt,name=applicant,proto3" json:"applicant,omitempty"` // 申请人信息
	ReqMsg        string                 `protobuf:"bytes,3,opt,name=reqMsg,proto3" json:"reqMsg,omitempty"`       // 申请消息
	Uuid          string                 `protobuf:"bytes,4,opt,name=uuid,proto3" json:"uuid,omitempty"`           // 申请唯一标识
	Request       *GroupRequest          `protobuf:"bytes,5,opt,name=request,proto3" json:"request,omitempty"`     // 申请详情
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MemberQuitTips struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Group                *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	QuitUser             *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=quitUser,proto3" json:"quitUser,omitempty"`                         // 退出成员信息
	OperationTime        int64                  `protobuf:"varint,3,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	GroupMemberVersion   uint64                 `protobuf:"varint,4,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,5,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
...
type GroupApplicationAcceptedTips struct {
	...
	Group         *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`            // 群组信息
	OpUser        *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`          // 操作人信息
	HandleMsg     string                 `protobuf:"bytes,4,opt,name=handleMsg,proto3" json:"handleMsg,omitempty"`    // 处理消息
	ReceiverAs    int32                  `protobuf:"varint,5,opt,name=receiverAs,proto3" json:"receiverAs,omitempty"` // 接收者身份(1-管理员, 0-申请人)
	Uuid          string                 `protobuf:"bytes,6,opt,name=uuid,proto3" json:"uuid,omitempty"`              // 申请唯一标识
	Request       *GroupRequest          `protobuf:"bytes,7,opt,name=request,proto3" json:"request,omitempty"`        // 申请详情
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GroupOwnerTransferredTips struct {
	...
	Group                *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	NewGroupOwner        *GroupMemberFullInfo   `protobuf:"bytes,3,opt,name=newGroupOwner,proto3" json:"newGroupOwner,omitempty"`               // 新群主信息
	OldGroupOwner        string                 `protobuf:"bytes,4,opt,name=oldGroupOwner,proto3" json:"oldGroupOwner,omitempty"`               // 旧群主ID
	OperationTime        int64                  `protobuf:"varint,5,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	OldGroupOwnerInfo    *GroupMemberFullInfo   `protobuf:"bytes,6,opt,name=oldGroupOwnerInfo,proto3" json:"oldGroupOwnerInfo,omitempty"`       // 旧群主信息
	GroupMemberVersion   uint64                 `protobuf:"varint,7,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,8,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type MemberKickedTips struct {
	...
	Group                *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	KickedUserList       []*GroupMemberFullInfo `protobuf:"bytes,3,rep,name=kickedUserList,proto3" json:"kickedUserList,omitempty"`             // 被踢成员列表
	OperationTime        int64                  `protobuf:"varint,4,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	GroupMemberVersion   uint64                 `protobuf:"varint,5,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,6,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type MemberInvitedTips struct {
	...
	Group                *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	InvitedUserList      []*GroupMemberFullInfo `protobuf:"bytes,3,rep,name=invitedUserList,proto3" json:"invitedUserList,omitempty"`           // 被邀请成员列表
	OperationTime        int64                  `protobuf:"varint,4,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	GroupMemberVersion   uint64                 `protobuf:"varint,5,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,6,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	InviterUser          *GroupMemberFullInfo   `protobuf:"bytes,7,opt,name=inviterUser,proto3" json:"inviterUser,omitempty"`                   // 邀请人信息
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type MemberEnterTips struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Group                *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`                               // 群组信息
	EntrantUser          *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=entrantUser,proto3" json:"entrantUser,omitempty"`                   // 加入成员信息
	OperationTime        int64                  `protobuf:"varint,3,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	GroupMemberVersion   uint64                 `protobuf:"varint,5,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,6,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
...
type GroupMemberMutedTips struct {
	...
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	OperationTime        int64                  `protobuf:"varint,3,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	MutedUser            *GroupMemberFullInfo   `protobuf:"bytes,4,opt,name=mutedUser,proto3" json:"mutedUser,omitempty"`                       // 被禁言成员信息
	MutedSeconds         uint32                 `protobuf:"varint,5,opt,name=mutedSeconds,proto3" json:"mutedSeconds,omitempty"`                // 禁言时长(秒)
	GroupMemberVersion   uint64                 `protobuf:"varint,6,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,7,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
...
type GroupMemberCancelMutedTips struct {
	...
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	OperationTime        int64                  `protobuf:"varint,3,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	MutedUser            *GroupMemberFullInfo   `protobuf:"bytes,4,opt,name=mutedUser,proto3" json:"mutedUser,omitempty"`                       // 被解除禁言成员信息
	GroupMemberVersion   uint64                 `protobuf:"varint,5,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,6,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
...
type GroupMemberInfoSetTips struct {
	...
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`                             // 操作人信息
	OperationTime        int64                  `protobuf:"varint,3,opt,name=operationTime,proto3" json:"operationTime,omitempty"`              // 操作时间戳
	ChangedUser          *GroupMemberFullInfo   `protobuf:"bytes,4,opt,name=changedUser,proto3" json:"changedUser,omitempty"`                   // 被修改成员信息
	GroupMemberVersion   uint64                 `protobuf:"varint,5,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`    // 群成员版本号
	GroupMemberVersionID string                 `protobuf:"bytes,6,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"` // 群成员版本ID
	GroupSortVersion     uint64                 `protobuf:"varint,7,opt,name=groupSortVersion,proto3" json:"groupSortVersion,omitempty"`        // 群排序版本号
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type FriendApplication struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AddTime       int64                  `protobuf:"varint,1,opt,name=addTime,proto3" json:"addTime,omitempty"`      // 添加时间戳
	AddSource     string                 `protobuf:"bytes,2,opt,name=addSource,proto3" json:"addSource,omitempty"`   // 添加来源
	AddWording    string                 `protobuf:"bytes,3,opt,name=addWording,proto3" json:"addWording,omitempty"` // 添加备注
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FromToUserID struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromUserID    string                 `protobuf:"bytes,1,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"` // 发起者ID
	ToUserID      string                 `protobuf:"bytes,2,opt,name=toUserID,proto3" json:"toUserID,omitempty"`     // 接收者ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendApplicationTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID  *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"` // 发起者和接收者ID对
	Request       *FriendRequest         `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`           // 申请详情
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendApplicationApprovedTips struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID    *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"`       // 同意者和申请者ID对
	HandleMsg       string                 `protobuf:"bytes,2,opt,name=handleMsg,proto3" json:"handleMsg,omitempty"`             // 处理消息
	FriendVersion   uint64                 `protobuf:"varint,3,opt,name=friendVersion,proto3" json:"friendVersion,omitempty"`    // 好友版本号
	FriendVersionID string                 `protobuf:"bytes,4,opt,name=friendVersionID,proto3" json:"friendVersionID,omitempty"` // 好友版本ID
	Request         *FriendRequest         `protobuf:"bytes,5,opt,name=request,proto3" json:"request,omitempty"`                 // 申请详情
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type FriendApplicationRejectedTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID  *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"` // 拒绝者和申请者ID对
	HandleMsg     string                 `protobuf:"bytes,2,opt,name=handleMsg,proto3" json:"handleMsg,omitempty"`       // 处理消息
	Request       *FriendRequest         `protobuf:"bytes,3,opt,name=request,proto3" json:"request,omitempty"`           // 申请详情
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendAddedTips struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Friend          *FriendInfo            `protobuf:"bytes,1,opt,name=friend,proto3" json:"friend,omitempty"`                   // 好友信息
	OperationTime   int64                  `protobuf:"varint,2,opt,name=operationTime,proto3" json:"operationTime,omitempty"`    // 操作时间戳
	OpUser          *PublicUserInfo        `protobuf:"bytes,3,opt,name=opUser,proto3" json:"opUser,omitempty"`                   // 操作人信息
	FriendVersion   uint64                 `protobuf:"varint,4,opt,name=friendVersion,proto3" json:"friendVersion,omitempty"`    // 好友版本号
	FriendVersionID string                 `protobuf:"bytes,5,opt,name=friendVersionID,proto3" json:"friendVersionID,omitempty"` // 好友版本ID
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type FriendDeletedTips struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID    *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"`       // 删除者和被删除者ID对
	FriendVersion   uint64                 `protobuf:"varint,2,opt,name=friendVersion,proto3" json:"friendVersion,omitempty"`    // 好友版本号
	FriendVersionID string                 `protobuf:"bytes,3,opt,name=friendVersionID,proto3" json:"friendVersionID,omitempty"` // 好友版本ID
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type BlackAddedTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID  *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"` // 添加者和被拉黑者ID对
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BlackDeletedTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID  *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"` // 删除者和被移除者ID对
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendInfoChangedTips struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID      *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"`            // 变更者和好友ID对
	FriendVersion     uint64                 `protobuf:"varint,2,opt,name=friendVersion,proto3" json:"friendVersion,omitempty"`         // 好友版本号
	FriendVersionID   string                 `protobuf:"bytes,3,opt,name=friendVersionID,proto3" json:"friendVersionID,omitempty"`      // 好友版本ID
	FriendSortVersion uint64                 `protobuf:"varint,4,opt,name=friendSortVersion,proto3" json:"friendSortVersion,omitempty"` // 好友排序版本号
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type UserStatusChangeTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromUserID    string                 `protobuf:"bytes,1,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"`  // 状态变更用户ID
	ToUserID      string                 `protobuf:"bytes,2,opt,name=toUserID,proto3" json:"toUserID,omitempty"`      // 订阅者ID
	Status        int32                  `protobuf:"varint,3,opt,name=status,proto3" json:"status,omitempty"`         // 在线状态(1-在线, 0-离线)
...
type UserCommandAddTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromUserID    string                 `protobuf:"bytes,1,opt,name=fromUserID,proto3" json:"fromUserID,omitempty"` // 发送者ID
	ToUserID      string                 `protobuf:"bytes,2,opt,name=toUserID,proto3" json:"toUserID,omitempty"`     // 接收者ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ConversationUpdateTips struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	UserID             string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                         // 用户ID
	ConversationIDList []string               `protobuf:"bytes,2,rep,name=conversationIDList,proto3" json:"conversationIDList,omitempty"` // 会话ID列表
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type ConversationSetPrivateTips struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RecvID         string                 `protobuf:"bytes,1,opt,name=recvID,proto3" json:"recvID,omitempty"`                 // 接收者ID
	SendID         string                 `protobuf:"bytes,2,opt,name=sendID,proto3" json:"sendID,omitempty"`                 // 发送者ID
	IsPrivate      bool                   `protobuf:"varint,3,opt,name=isPrivate,proto3" json:"isPrivate,omitempty"`          // 是否私聊
	ConversationID string                 `protobuf:"bytes,4,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ConversationHasReadTips struct {
	...
	HasReadSeq      int64                  `protobuf:"varint,3,opt,name=hasReadSeq,proto3" json:"hasReadSeq,omitempty"`           // 已读序列号
	UnreadCountTime int64                  `protobuf:"varint,4,opt,name=unreadCountTime,proto3" json:"unreadCountTime,omitempty"` // 未读计数时间戳
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type NotificationElem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Detail        string                 `protobuf:"bytes,1,opt,name=detail,proto3" json:"detail,omitempty"` // 详细内容
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Seqs struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Seqs          []int64                `protobuf:"varint,1,rep,packed,name=seqs,proto3" json:"seqs,omitempty"` // 序列号列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DeleteMessageTips struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OpUserID      string                 `protobuf:"bytes,1,opt,name=opUserID,proto3" json:"opUserID,omitempty"` // 操作人ID
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`     // 用户ID
	Seqs          []int64                `protobuf:"varint,3,rep,packed,name=seqs,proto3" json:"seqs,omitempty"` // 被删除消息序列号列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RevokeMsgTips struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RevokerUserID  string                 `protobuf:"bytes,1,opt,name=revokerUserID,proto3" json:"revokerUserID,omitempty"`   // 撤回者ID
	ClientMsgID    string                 `protobuf:"bytes,2,opt,name=clientMsgID,proto3" json:"clientMsgID,omitempty"`       // 客户端消息ID
	RevokeTime     int64                  `protobuf:"varint,3,opt,name=revokeTime,proto3" json:"revokeTime,omitempty"`        // 撤回时间戳
	SesstionType   int32                  `protobuf:"varint,5,opt,name=sesstionType,proto3" json:"sesstionType,omitempty"`    // 会话类型
	Seq            int64                  `protobuf:"varint,6,opt,name=seq,proto3" json:"seq,omitempty"`                      // 消息序列号
	ConversationID string                 `protobuf:"bytes,7,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	IsAdminRevoke  bool                   `protobuf:"varint,8,opt,name=isAdminRevoke,proto3" json:"isAdminRevoke,omitempty"`  // 是否管理员撤回
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type MessageRevokedContent struct {
	state                       protoimpl.MessageState `protogen:"open.v1"`
	RevokerID                   string                 `protobuf:"bytes,1,opt,name=revokerID,proto3" json:"revokerID,omitempty"`                                     // 撤回者ID
	RevokerRole                 int32                  `protobuf:"varint,2,opt,name=revokerRole,proto3" json:"revokerRole,omitempty"`                                // 撤回者角色
	ClientMsgID                 string                 `protobuf:"bytes,3,opt,name=clientMsgID,proto3" json:"clientMsgID,omitempty"`                                 // 客户端消息ID
	RevokerNickname             string                 `protobuf:"bytes,4,opt,name=revokerNickname,proto3" json:"revokerNickname,omitempty"`                         // 撤回者昵称
	RevokeTime                  int64                  `protobuf:"varint,5,opt,name=revokeTime,proto3" json:"revokeTime,omitempty"`                                  // 撤回时间戳
	SourceMessageSendTime       int64                  `protobuf:"varint,6,opt,name=sourceMessageSendTime,proto3" json:"sourceMessageSendTime,omitempty"`            // 原消息发送时间
	SourceMessageSendID         string                 `protobuf:"bytes,7,opt,name=sourceMessageSendID,proto3" json:"sourceMessageSendID,omitempty"`                 // 原消息发送者ID
	SourceMessageSenderNickname string                 `protobuf:"bytes,8,opt,name=sourceMessageSenderNickname,proto3" json:"sourceMessageSenderNickname,omitempty"` // 原消息发送者昵称
	SessionType                 int32                  `protobuf:"varint,10,opt,name=sessionType,proto3" json:"sessionType,omitempty"`                               // 会话类型
	Seq                         int64                  `protobuf:"varint,11,opt,name=seq,proto3" json:"seq,omitempty"`                                               // 消息序列号
	Ex                          string                 `protobuf:"bytes,12,opt,name=ex,proto3" json:"ex,omitempty"`                                                  // 扩展字段
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
type MarkAsReadTips struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	MarkAsReadUserID string                 `protobuf:"bytes,1,opt,name=markAsReadUserID,proto3" json:"markAsReadUserID,omitempty"` // 标记已读用户ID
	ConversationID   string                 `protobuf:"bytes,2,opt,name=conversationID,proto3" json:"conversationID,omitempty"`     // 会话ID
	Seqs             []int64                `protobuf:"varint,3,rep,packed,name=seqs,proto3" json:"seqs,omitempty"`                 // 被标记消息序列号列表
	HasReadSeq       int64                  `protobuf:"varint,4,opt,name=hasReadSeq,proto3" json:"hasReadSeq,omitempty"`            // 已读序列号
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type SetAppBackgroundStatusReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`              // 用户ID
	IsBackground  bool                   `protobuf:"varint,2,opt,name=isBackground,proto3" json:"isBackground,omitempty"` // 是否后台运行
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProcessUserCommand struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`          // 用户ID
	Type          int32                  `protobuf:"varint,2,opt,name=type,proto3" json:"type,omitempty"`             // 命令类型
	CreateTime    int64                  `protobuf:"varint,3,opt,name=createTime,proto3" json:"createTime,omitempty"` // 创建时间戳
	Uuid          string                 `protobuf:"bytes,4,opt,name=uuid,proto3" json:"uuid,omitempty"`              // 唯一标识
	Value         string                 `protobuf:"bytes,5,opt,name=value,proto3" json:"value,omitempty"`            // 命令值
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RequestPagination struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PageNumber    int32                  `protobuf:"varint,1,opt,name=pageNumber,proto3" json:"pageNumber,omitempty"` // 页码
	ShowNumber    int32                  `protobuf:"varint,2,opt,name=showNumber,proto3" json:"showNumber,omitempty"` // 每页数量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FriendsInfoUpdateTips struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	FromToUserID    *FromToUserID          `protobuf:"bytes,1,opt,name=fromToUserID,proto3" json:"fromToUserID,omitempty"`       // 用户ID对
...
type SubUserOnlineStatusElem struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	UserID            string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`                               // 用户ID
	OnlinePlatformIDs []int32                `protobuf:"varint,2,rep,packed,name=onlinePlatformIDs,proto3" json:"onlinePlatformIDs,omitempty"` // 在线平台ID列表
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type SubUserOnlineStatusTips struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Subscribers   []*SubUserOnlineStatusElem `protobuf:"bytes,1,rep,name=subscribers,proto3" json:"subscribers,omitempty"` // 订阅者列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubUserOnlineStatus struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	SubscribeUserID   []string               `protobuf:"bytes,1,rep,name=subscribeUserID,proto3" json:"subscribeUserID,omitempty"`     // 订阅用户ID列表
	UnsubscribeUserID []string               `protobuf:"bytes,2,rep,name=unsubscribeUserID,proto3" json:"unsubscribeUserID,omitempty"` // 取消订阅用户ID列表
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type StreamMsgTips struct {
	...
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID,omitempty"` // 会话ID
	ClientMsgID    string                 `protobuf:"bytes,2,opt,name=clientMsgID,proto3" json:"clientMsgID,omitempty"`       // 客户端消息ID
	StartIndex     int64                  `protobuf:"varint,3,opt,name=startIndex,proto3" json:"startIndex,omitempty"`        // 起始索引
	Packets        []string               `protobuf:"bytes,4,rep,name=packets,proto3" json:"packets,omitempty"`               // 数据包列表
	End            bool                   `protobuf:"varint,5,opt,name=end,proto3" json:"end,omitempty"`                      // 是否结束
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_sdkws_sdkws_proto_rawDesc = "" +
	...
	"\x12notificationUserID\x18\x11 \x01(\tR\x12notificationUserID\"\xba\x03\n" +
	...
	"\fintroduction\x18\x04 \x01(\tR\fintroduction\x12\x18\n" +
	"\afaceURL\x18\x05 \x01(\tR\afaceURL\x12.\n" +
	"\x02ex\x18\x06 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\x12I\n" +
	"\x10needVerification\x18\a \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\x10needVerification\x12E\n" +
	"\x0elookMemberInfo\x18\b \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\x0elookMemberInfo\x12K\n" +
	"\x11applyMemberFriend\x18\t \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\x11applyMemberFriend\"\xff\x02\n" +
	...
	"\x10globalRecvMsgOpt\x18\a \x01(\x05R\x10globalRecvMsgOpt\"\x99\x02\n" +
	"\x0eUserInfoWithEx\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12:\n" +
	"\bnickname\x18\x02 \x01(\v2\x1e.openim.wrapperspb.StringValueR\bnickname\x128\n" +
	"\afaceURL\x18\x03 \x01(\v2\x1e.openim.wrapperspb.StringValueR\afaceURL\x12.\n" +
	"\x02ex\x18\x04 \x01(\v2\x1e.openim.wrapperspb.StringValueR\x02ex\x12I\n" +
	"\x10globalRecvMsgOpt\x18\a \x01(\v2\x1d.openim.wrapperspb.Int32ValueR\x10globalRecvMsgOpt\"\x90\x02\n" +
	"\n" +
	"FriendInfo\x12 \n" +
	...
	"\rPullOrderDesc\x10\x01B/Z-github.com/PaperMan11/goim/pkg/protocol/sdkwsb\x06proto3"
...
var file_sdkws_sdkws_proto_goTypes = []any{
	...
	(*wrapperspb.StringValue)(nil),        // 83: openim.wrapperspb.StringValue
	(*wrapperspb.Int32Value)(nil),         // 84: openim.wrapperspb.Int32Value
}
var file_sdkws_sdkws_proto_depIdxs = []int32{
	83, // 0: openim.sdkws.GroupInfoForSet.ex:type_name -> openim.wrapperspb.StringValue
	84, // 1: openim.sdkws.GroupInfoForSet.needVerification:type_name -> openim.wrapperspb.Int32Value
	84, // 2: openim.sdkws.GroupInfoForSet.lookMemberInfo:type_name -> openim.wrapperspb.Int32Value
	84, // 3: openim.sdkws.GroupInfoForSet.applyMemberFriend:type_name -> openim.wrapperspb.Int32Value
	83, // 4: openim.sdkws.UserInfoWithEx.nickname:type_name -> openim.wrapperspb.StringValue
	83, // 5: openim.sdkws.UserInfoWithEx.faceURL:type_name -> openim.wrapperspb.StringValue
	83, // 6: openim.sdkws.UserInfoWithEx.ex:type_name -> openim.wrapperspb.StringValue
	84, // 7: openim.sdkws.UserInfoWithEx.globalRecvMsgOpt:type_name -> openim.wrapperspb.Int32Value
